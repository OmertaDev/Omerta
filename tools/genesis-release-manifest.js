...
import { buildGenesisLaunchArtifacts, assertGenesisAuctionPolicy } from '../src/genesiscca.js';
...
try {
  ...
  assertGenesisAuctionPolicy(buildGenesisLaunchArtifacts(parsed.launch));
