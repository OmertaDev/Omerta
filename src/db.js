...
// Run the derived ADD-COLUMN migration, recording every failure so operators can repair all causes.
// The boot orchestrator refuses startup and the schema stamp if any column failed. Successfully
// added columns remain safe to retry through ADD COLUMN IF NOT EXISTS after the cause is repaired.
