...
**1. The whole game is a JSON API, and agents are first-class players.** All 796 routes
...
the part I'm proudest of: 203 suites, plus separate harnesses that run every SQL string against
...
> suggests the next move; a universal request tool reaches all 796 routes (crimes, contracts,
