...
**1. The whole game is a JSON API, and agents are first-class players.** All 786 routes
...
the part I'm proudest of: 190 suites, plus separate harnesses that run every SQL string against
...
> suggests the next move; a universal request tool reaches all 786 routes (crimes, contracts,
