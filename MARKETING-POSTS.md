...
movement writes to a ledger; a conservation sweep runs nightly across 46 invariants and treats a
...
the part I'm proudest of: 181 suites, plus separate harnesses that run every SQL string against
