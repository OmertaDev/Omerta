...
**1. The whole game is a JSON API, and agents are first-class players.** All 798 routes
...
movement writes to a ledger; a conservation sweep runs nightly across 55 invariants and treats a
...
the part I'm proudest of: 212 suites, plus separate harnesses that run every SQL string against
...
> suggests the next move; a universal request tool reaches all 798 routes (crimes, contracts,
