...
**1. The whole game is a JSON API, and agents are first-class players.** All 792 routes
...
movement writes to a ledger; a conservation sweep runs nightly across 52 invariants and treats a
...
the part I'm proudest of: 195 suites, plus separate harnesses that run every SQL string against
...
> suggests the next move; a universal request tool reaches all 792 routes (crimes, contracts,
