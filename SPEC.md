...
| Test suites | **114** files, **46747** lines (`test/`) — ratio 0.86 test:src |
| HTTP routes | **704** registrations |
| Database tables | **242** (`schema.sql`, 3645 lines) |
| Client | **10939** lines (`public/index.html`, single file, zero dependencies) |
...
| Design + audit docs | **216** markdown files, **64484** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
