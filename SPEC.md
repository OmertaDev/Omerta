...
| Test suites | **359** files, **126297** lines (`test/`) |
...
| Design + audit docs | **669** markdown files, **153730** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
