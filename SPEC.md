...
| Test suites | **310** files, **120305** lines (`test/`) |
...
| Design + audit docs | **643** markdown files, **152115** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
