...
| Test suites | **280** files, **116074** lines (`test/`) |
...
| Design + audit docs | **627** markdown files, **151012** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
