...
| | |
|---|---|
| Backend modules | **274** files, **106683** lines (`src/`, including routes and social modules) |
| Test suites | **346** files, **124723** lines (`test/`) |
...
| Design + audit docs | **660** markdown files, **153032** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
