...
Census refreshed 2026-09-21 from this workspace, including untracked source and documentation files; these counts do not identify a deployed revision.

| | |
|---|---|
| Backend modules | **274** files, **106416** lines (`src/`, including routes and social modules) |
| Test suites | **370** files, **127491** lines (`test/`) |
...
| Design + audit docs | **677** markdown files, **153430** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
