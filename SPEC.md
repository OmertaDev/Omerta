...
| Smart contracts | **20** contracts, **4476** lines Solidity, **336** Foundry tests passing |
...
| Design + audit docs | **414** markdown files, **88197** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
