...
| Test suites | **161** files, **86874** lines (`test/`) — ratio 1.02 test:src |
...
| Design + audit docs | **490** markdown files, **130035** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
