...
| | |
|---|---|
| Backend modules | **274** files, **106645** lines (`src/`, including routes and social modules) |
| Test suites | **318** files, **121305** lines (`test/`) |
...
| Design + audit docs | **647** markdown files, **152242** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
