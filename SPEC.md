...
| Test suites | **424** files, **135851** lines (`test/`) |
...
| Design + audit docs | **695** markdown files, **154820** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
