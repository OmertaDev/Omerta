...
| Client | **11173** lines (`public/index.html`, single file, zero dependencies) |
...
| Design + audit docs | **213** markdown files, **63713** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
