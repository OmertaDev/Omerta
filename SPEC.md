...
| Test suites | **329** files, **122396** lines (`test/`) |
...
| Design + audit docs | **651** markdown files, **152470** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
