...
| Test suites | **361** files, **126613** lines (`test/`) |
...
| Design + audit docs | **670** markdown files, **153766** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
