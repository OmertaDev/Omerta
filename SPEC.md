...
| | |
|---|---|
| Backend modules | **274** files, **106339** lines (`src/`, including routes and social modules) |
| Test suites | **272** files, **114561** lines (`test/`) |
...
| Design + audit docs | **620** markdown files, **149823** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
