...
| | |
|---|---|
| Backend modules | **164** files, **57187** lines (`src/`, incl. `src/routes/` and `src/social/`) |
...
| Design + audit docs | **416** markdown files, **88844** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
