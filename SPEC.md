...
| Test suites | **120** files, **50933** lines (`test/`) — ratio 0.90 test:src |
...
| Smart contracts | **21** contracts, **5325** lines Solidity, **406** Foundry tests passing |
...
| Design + audit docs | **415** markdown files, **93123** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
