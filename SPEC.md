...
| Test suites | **345** files, **124605** lines (`test/`) |
...
| Design + audit docs | **659** markdown files, **152981** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
