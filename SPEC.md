...
| Test suites | **305** files, **119741** lines (`test/`) |
...
| Design + audit docs | **641** markdown files, **152063** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
