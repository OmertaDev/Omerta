...
| Test suites | **369** files, **127375** lines (`test/`) |
...
| Design + audit docs | **676** markdown files, **153395** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
