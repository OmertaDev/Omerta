...
| Test suites | **334** files, **123082** lines (`test/`) |
...
| Design + audit docs | **654** markdown files, **152609** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
