...
| Test suites | **379** files, **128529** lines (`test/`) |
...
| Design + audit docs | **686** markdown files, **153890** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
