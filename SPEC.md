...
| | |
|---|---|
| Backend modules | **273** files, **106552** lines (`src/`, including routes and social modules) |
| Test suites | **264** files, **114211** lines (`test/`) |
...
| Design + audit docs | **615** markdown files, **150051** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
