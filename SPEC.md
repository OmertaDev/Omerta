...
| Test suites | **292** files, **117344** lines (`test/`) |
...
| Design + audit docs | **634** markdown files, **151548** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
