...
| | |
|---|---|
| Backend modules | **274** files, **106625** lines (`src/`, including routes and social modules) |
| Test suites | **299** files, **118798** lines (`test/`) |
...
| Design + audit docs | **639** markdown files, **151919** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
