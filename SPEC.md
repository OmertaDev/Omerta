...
| | |
|---|---|
| Backend modules | **214** files, **93362** lines (`src/`, incl. `src/routes/` and `src/social/`) |
| Test suites | **176** files, **97306** lines (`test/`) — ratio 1.04 test:src |
...
| Design + audit docs | **510** markdown files, **139060** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
