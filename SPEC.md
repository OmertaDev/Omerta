...
| Test suites | **357** files, **126182** lines (`test/`) |
...
| Design + audit docs | **668** markdown files, **153668** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
