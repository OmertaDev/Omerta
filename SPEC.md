...
| Test suites | **153** files, **76107** lines (`test/`) — ratio 1.00 test:src |
...
| Design + audit docs | **488** markdown files, **128505** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
