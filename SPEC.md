...
| | |
|---|---|
| Backend modules | **257** files, **103310** lines (`src/`, incl. `src/routes/` and `src/social/`) |
| Test suites | **235** files, **110035** lines (`test/`) — ratio 1.07 test:src |
| HTTP routes | **798** registrations (**798** unique) |
| Database tables | **361** (`schema.sql`, 7268 lines) |
...
| Design + audit docs | **594** markdown files, **147487** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
