...
| Test suites | **300** files, **118926** lines (`test/`) |
...
| Design + audit docs | **640** markdown files, **151963** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
