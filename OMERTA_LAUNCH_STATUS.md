...
Final candidate: **Candidate20**, `d2a1804e23c59902935e42357e1296c899374cab`, recorded in FINAL_LAUNCH_SHA. Targeted recovery passed on both PostgreSQL versions. Required CI exposed a stale documentation census, now corrected locally; Candidate19 and Candidate20 remain immutable.
...
| Upgrade | FAIL — API pair passes both databases; pair-specific worker proof pending |
| Rollback | FAIL — API rollback passes both databases; predecessor worker on candidate state unverified |
