...
try {
  ...
  const request = { method: 'POST', routeOptions: { url: '/v1/screens' } };
  ...
  console.log('PASS RC1-MOBILE-CONFIRM: passive screen beacons preserve confirmations; gameplay invalidation remains enabled');
