...
const DISPOSITION = {
  ...
  world_operation_commitments: 'ledger', // original actor identity persists; current-character checks prevent an heir fulfilling or inheriting the seat
  world_operation_capital: 'escrow', // operation recovery/settlement preserves the original depositor; a dead original forfeits held cash, never pays an heir
