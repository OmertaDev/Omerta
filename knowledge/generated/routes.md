...
| GET | `/beef/:a/:b` | public | client-experience | [src/server.js:604](../../src/server.js#L604) | `clip` |
| GET | `/card/:type/:name` | public | client-experience | [src/server.js:568](../../src/server.js#L568) | `clip` |
| GET | `/card/beef/:a/:b` | public | client-experience | [src/server.js:584](../../src/server.js#L584) | `clip` |
...
| GET | `/health` | public | client-experience | [src/server.js:786](../../src/server.js#L786) | `healthTtl` |
...
| GET | `/u/:name` | public | client-experience | [src/server.js:598](../../src/server.js#L598) | `clip` |
...
| POST | `/v1/auth/agent-key` | authenticated | platform-core | [src/server.js:1198](../../src/server.js#L1198) | `signFor` |
| POST | `/v1/auth/guest` | public | platform-core | [src/server.js:1108](../../src/server.js#L1108) | `signFor` |
| POST | `/v1/auth/logout-all` | authenticated | platform-core | [src/server.js:1207](../../src/server.js#L1207) | `closeAccountSockets` |
...
| GET | `/v1/auth/x/callback` | public | platform-core | [src/server.js:1166](../../src/server.js#L1166) | `cookieVal` |
...
| POST | `/v1/gangs/kick` | authenticated | platform-core | [src/server.js:1466](../../src/server.js#L1466) | `closeAccountSockets` |
| POST | `/v1/gangs/leave` | authenticated | platform-core | [src/server.js:1457](../../src/server.js#L1457) | `closeAccountSockets` |
...
| POST | `/v1/path-quiz` | public | platform-core | [src/server.js:1049](../../src/server.js#L1049) | `validPathSession` |
...
| POST | `/v1/streets/:targetId/fire` | authenticated | platform-core | [src/server.js:2486](../../src/server.js#L2486) | `closeSocketsOnKill` |
| POST | `/v1/streets/:targetId/jump` | authenticated | social-combat | [src/server.js:2254](../../src/server.js#L2254) | `S.jump` |
| POST | `/v1/streets/:targetId/npchit` | authenticated | platform-core | [src/server.js:2444](../../src/server.js#L2444) | `closeSocketsOnKill` |
...
| GET | `/v1/u/:name` | public | platform-core | [src/server.js:566](../../src/server.js#L566) | `clip` |
