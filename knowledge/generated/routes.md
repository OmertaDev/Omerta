...
| POST | `/v1/access/logout` | public | platform-core | [src/server.js:1330](../../src/server.js#L1330) | — |
| POST | `/v1/access/redeem` | public | platform-core | [src/server.js:1314](../../src/server.js#L1314) | `G.GameError` |
| POST | `/v1/access/session` | authenticated | platform-core | [src/server.js:1323](../../src/server.js#L1323) | — |
| POST | `/v1/agent/act` | authenticated | platform-core | [src/server.js:2613](../../src/server.js#L2613) | `executeAgentAction` |
| GET | `/v1/agent/turn` | authenticated | platform-core | [src/server.js:2554](../../src/server.js#L2554) | `readAgentTurn` |
| GET | `/v1/arena` | public | engagement-growth | [src/server.js:2665](../../src/server.js#L2665) | `arenaBoard` |
| POST | `/v1/armory/ammo` | authenticated | economy-ledger | [src/server.js:1684](../../src/server.js#L1684) | `E.buyAmmo` |
| POST | `/v1/armory/gun/:id/buy` | authenticated | economy-ledger | [src/server.js:1676](../../src/server.js#L1676) | `E.buyGun` |
| POST | `/v1/armory/gun/:id/equip` | authenticated | economy-ledger | [src/server.js:1678](../../src/server.js#L1678) | `E.equipGun` |
| POST | `/v1/armory/unequip` | authenticated | economy-ledger | [src/server.js:1680](../../src/server.js#L1680) | `E.equipGun` |
| POST | `/v1/armory/vest/:id` | authenticated | economy-ledger | [src/server.js:1682](../../src/server.js#L1682) | `E.buyVest` |
...
| POST | `/v1/assets/:id/buy` | authenticated | economy-ledger | [src/server.js:1629](../../src/server.js#L1629) | `E.buyAsset` |
| POST | `/v1/assets/:id/sell` | authenticated | economy-ledger | [src/server.js:1631](../../src/server.js#L1631) | `E.sellAsset` |
| GET | `/v1/auction` | authenticated | platform-core | [src/server.js:2230](../../src/server.js#L2230) | `Auction.auctionBoard` |
| POST | `/v1/auction/:lotId/bid` | authenticated | platform-core | [src/server.js:2232](../../src/server.js#L2232) | `Auction.bidAuction` |
| POST | `/v1/auction/consign` | authenticated | platform-core | [src/server.js:2235](../../src/server.js#L2235) | `Auction.consignTrophy` |
| POST | `/v1/auction/consign/:id/bid` | authenticated | platform-core | [src/server.js:2237](../../src/server.js#L2237) | `Auction.bidConsignment` |
| POST | `/v1/auction/consign/:id/cancel` | authenticated | platform-core | [src/server.js:2239](../../src/server.js#L2239) | `Auction.reclaimConsignment` |
| POST | `/v1/auth/agent-key` | authenticated | platform-core | [src/server.js:1421](../../src/server.js#L1421) | `A.acknowledgeGuestBootstrap` |
| POST | `/v1/auth/guest` | public | platform-core | [src/server.js:1313](../../src/server.js#L1313) | — |
| POST | `/v1/auth/guest/bootstrap/ack` | authenticated | platform-core | [src/server.js:1334](../../src/server.js#L1334) | `A.acknowledgeGuestBootstrap` |
| POST | `/v1/auth/logout-all` | authenticated | platform-core | [src/server.js:1431](../../src/server.js#L1431) | — |
| POST | `/v1/auth/privy` | public | platform-core | [src/server.js:1344](../../src/server.js#L1344) | `providerLogin` |
| POST | `/v1/auth/upgrade` | authenticated | platform-core | [src/server.js:1412](../../src/server.js#L1412) | `A.upgradeAccount` |
| POST | `/v1/auth/x` | public | platform-core | [src/server.js:1343](../../src/server.js#L1343) | `providerLogin` |
| GET | `/v1/auth/x/callback` | public | platform-core | [src/server.js:1386](../../src/server.js#L1386) | `A.xOAuthCallback` |
| POST | `/v1/auth/x/start` | public | platform-core | [src/server.js:1354](../../src/server.js#L1354) | `A.upgradeAccount` |
| GET | `/v1/avatar/:seed` | public | platform-core | [src/server.js:635](../../src/server.js#L635) | — |
| GET | `/v1/bank` | authenticated | platform-core | [src/server.js:2210](../../src/server.js#L2210) | `Bank.bankBoard` |
| POST | `/v1/bank/:dir` | authenticated | platform-core | [src/server.js:1597](../../src/server.js#L1597) | `G.withCharacter` |
| GET | `/v1/block` | authenticated | social-combat | [src/server.js:2436](../../src/server.js#L2436) | `Block.streetsBoard` |
| GET | `/v1/bloodline` | authenticated | platform-core | [src/server.js:3258](../../src/server.js#L3258) | `Bloodline.bloodlineBoard` |
| POST | `/v1/bodyguard/hire/:guardId` | authenticated | social-combat | [src/server.js:2713](../../src/server.js#L2713) | `S.hireBodyguard` |
| POST | `/v1/bodyguard/offer` | authenticated | social-combat | [src/server.js:2711](../../src/server.js#L2711) | `S.offerBodyguard` |
| POST | `/v1/bond/calldata` | authenticated | chain-economy | [src/server.js:3359](../../src/server.js#L3359) | `Chain.bondCalldata` |
| POST | `/v1/bond/quote` | authenticated | chain-economy | [src/server.js:3356](../../src/server.js#L3356) | `Chain.quoteBond` |
| GET | `/v1/bonds` | authenticated | platform-core | [src/server.js:3348](../../src/server.js#L3348) | `Bonds.bondBoard` |
| POST | `/v1/bonds/:id/claim` | authenticated | platform-core | [src/server.js:3349](../../src/server.js#L3349) | `Bonds.claimBond` |
| POST | `/v1/bonds/charter` | authenticated | platform-core | [src/server.js:3354](../../src/server.js#L3354) | `Bonds.commissionCharter` |
| POST | `/v1/bonds/pledge` | authenticated | platform-core | [src/server.js:3352](../../src/server.js#L3352) | `Bonds.pledgeTreasury` |
...
| POST | `/v1/broadcast/shared` | authenticated | platform-core | [src/server.js:1566](../../src/server.js#L1566) | `G.track` |
| GET | `/v1/brokers` | authenticated | platform-core | [src/server.js:2251](../../src/server.js#L2251) | `Brokers.brokerBoard` |
| POST | `/v1/brokers/activate` | authenticated | platform-core | [src/server.js:2253](../../src/server.js#L2253) | `Brokers.activate` |
| GET | `/v1/bulletin` | authenticated | engagement-growth | [src/server.js:3512](../../src/server.js#L3512) | `bulletinBoard` |
| POST | `/v1/bulletin/claim` | authenticated | platform-core | [src/server.js:3517](../../src/server.js#L3517) | `G.withCharacter` |
| GET | `/v1/business` | authenticated | enterprise-logistics | [src/server.js:2069](../../src/server.js#L2069) | `Business.businessesOf` |
| DELETE | `/v1/business/:id` | authenticated | enterprise-logistics | [src/server.js:2041](../../src/server.js#L2041) | `Business.shutterBusiness` |
| POST | `/v1/business/:id/launder` | authenticated | enterprise-logistics | [src/server.js:2043](../../src/server.js#L2043) | `Business.launderAtBusiness` |
| POST | `/v1/business/:id/rob` | authenticated | enterprise-logistics | [src/server.js:2054](../../src/server.js#L2054) | `Business.robBusiness` |
| POST | `/v1/business/:id/shakedown` | authenticated | enterprise-logistics | [src/server.js:2047](../../src/server.js#L2047) | `Business.shakedownBusiness` |
| POST | `/v1/business/:id/specialize` | authenticated | enterprise-logistics | [src/server.js:2061](../../src/server.js#L2061) | `Business.specializeBusiness` |
| POST | `/v1/business/:id/takeover` | authenticated | enterprise-logistics | [src/server.js:2063](../../src/server.js#L2063) | `Business.takeoverBusiness` |
| POST | `/v1/business/:id/upgrade` | authenticated | enterprise-logistics | [src/server.js:2036](../../src/server.js#L2036) | `Business.upgradeBusiness` |
| POST | `/v1/business/:kind/buy` | authenticated | enterprise-logistics | [src/server.js:2028](../../src/server.js#L2028) | `Business.buyBusiness` |
| POST | `/v1/business/collect` | authenticated | enterprise-logistics | [src/server.js:2030](../../src/server.js#L2030) | `Business.collectBusiness` |
| POST | `/v1/business/upkeep` | authenticated | enterprise-logistics | [src/server.js:2034](../../src/server.js#L2034) | `Business.payBusinessUpkeep` |
| POST | `/v1/call/fulfill` | authenticated | engagement-growth | [src/server.js:3027](../../src/server.js#L3027) | `Contacts.fulfillCall` |
| GET | `/v1/campaigns` | authenticated | platform-core | [src/server.js:3250](../../src/server.js#L3250) | `Campaigns.campaignBoard` |
| POST | `/v1/campaigns/:id/choose` | authenticated | platform-core | [src/server.js:3254](../../src/server.js#L3254) | `Campaigns.chooseCampaign` |
| POST | `/v1/campaigns/:id/claim` | authenticated | platform-core | [src/server.js:3256](../../src/server.js#L3256) | `Campaigns.claimCampaign` |
| POST | `/v1/campaigns/:id/start` | authenticated | platform-core | [src/server.js:3252](../../src/server.js#L3252) | `Campaigns.startCampaign` |
| GET | `/v1/capo` | authenticated | engagement-growth | [src/routes/leaderboards.js:88](../../src/routes/leaderboards.js#L88) | `W.capoBoard` |
| GET | `/v1/career` | authenticated | engagement-growth | [src/server.js:3230](../../src/server.js#L3230) | `Career.careerBoard` |
| POST | `/v1/career/:taskId` | authenticated | engagement-growth | [src/server.js:3232](../../src/server.js#L3232) | `Career.claimCareer` |
...
| GET | `/v1/catalog` | public | enterprise-logistics | [src/server.js:1749](../../src/server.js#L1749) | `Business.catalog` |
| POST | `/v1/character` | authenticated | platform-core | [src/server.js:1445](../../src/server.js#L1445) | `Store.claimPendingWire` |
| POST | `/v1/character/forge` | authenticated | chain-economy | [src/server.js:3410](../../src/server.js#L3410) | `Forge.forgeCharacter` |
| POST | `/v1/character/mint` | authenticated | economy-ledger | [src/server.js:3401](../../src/server.js#L3401) | `Fees.mintCharacter` |
| POST | `/v1/character/reroll` | authenticated | economy-ledger | [src/server.js:3404](../../src/server.js#L3404) | `Fees.rerollCharacter` |
| GET | `/v1/chat` | authenticated | platform-core | [src/server.js:3003](../../src/server.js#L3003) | `readChat` |
| POST | `/v1/chat` | authenticated | platform-core | [src/server.js:3002](../../src/server.js#L3002) | `postChat` |
| POST | `/v1/checkin` | authenticated | platform-core | [src/server.js:1562](../../src/server.js#L1562) | `G.withCharacter` |
| GET | `/v1/circle` | authenticated | engagement-growth | [src/server.js:3142](../../src/server.js#L3142) | `Circle.circleBoard` |
| GET | `/v1/city` | public | platform-core | [src/server.js:3467](../../src/server.js#L3467) | — |
| GET | `/v1/citywide` | authenticated | world-progression | [src/server.js:2440](../../src/server.js#L2440) | `Citywide.citywideBoard` |
| POST | `/v1/claim-rewards` | authenticated | economy-ledger | [src/server.js:1670](../../src/server.js#L1670) | `E.claimRewards` |
| GET | `/v1/clues` | authenticated | platform-core | [src/server.js:3543](../../src/server.js#L3543) | `Clues.clueBoard` |
| POST | `/v1/clues/dig` | authenticated | platform-core | [src/server.js:3545](../../src/server.js#L3545) | `Clues.dig` |
| GET | `/v1/collection` | authenticated | law-intelligence | [src/server.js:3317](../../src/server.js#L3317) | `Collection.collectionBoard` |
...
| GET | `/v1/commission` | public | platform-core | [src/server.js:2085](../../src/server.js#L2085) | `Commission.commissionBoard` |
| POST | `/v1/commission/override` | authenticated | platform-core | [src/server.js:2094](../../src/server.js#L2094) | `Commission.overrideVeto` |
| POST | `/v1/commission/propose` | authenticated | platform-core | [src/server.js:2091](../../src/server.js#L2091) | `Commission.proposeDecree` |
| GET | `/v1/commission/ticker` | public | platform-core | [src/server.js:2099](../../src/server.js#L2099) | `Commission.tickerBallotBoard` |
| POST | `/v1/commission/ticker` | authenticated | platform-core | [src/server.js:2100](../../src/server.js#L2100) | `Commission.castTickerVote` |
| POST | `/v1/commission/veto` | authenticated | platform-core | [src/server.js:2088](../../src/server.js#L2088) | `Commission.vetoDecree` |
| POST | `/v1/commission/vote` | authenticated | platform-core | [src/server.js:2086](../../src/server.js#L2086) | `Commission.castVote` |
| GET | `/v1/contacts` | authenticated | engagement-growth | [src/server.js:3021](../../src/server.js#L3021) | `Contacts.contactsBoard` |
...
| GET | `/v1/contracts` | authenticated | social-combat | [src/server.js:2532](../../src/server.js#L2532) | `S.listContracts` |
| POST | `/v1/contracts/:targetId/:kind/cancel` | authenticated | social-combat | [src/server.js:2536](../../src/server.js#L2536) | `S.cancelBounty` |
| POST | `/v1/contracts/peek` | authenticated | social-combat | [src/server.js:2534](../../src/server.js#L2534) | `S.peekContracts` |
...
| GET | `/v1/convoys` | authenticated | enterprise-logistics | [src/server.js:2302](../../src/server.js#L2302) | `Convoy.convoyBoard` |
...
| GET | `/v1/corner` | authenticated | platform-core | [src/server.js:1554](../../src/server.js#L1554) | `Corner.cornerBoard` |
| POST | `/v1/corner/:slot/accept` | authenticated | platform-core | [src/server.js:1556](../../src/server.js#L1556) | `Corner.acceptCorner` |
| POST | `/v1/corner/:slot/claim` | authenticated | platform-core | [src/server.js:1558](../../src/server.js#L1558) | `Corner.claimCorner` |
| GET | `/v1/crew` | authenticated | social-combat | [src/server.js:3049](../../src/server.js#L3049) | `Crew.crewBoard` |
| POST | `/v1/crew` | authenticated | social-combat | [src/server.js:3059](../../src/server.js#L3059) | `Crew.createCrew` |
| POST | `/v1/crew/accept/:crewId` | authenticated | social-combat | [src/server.js:3063](../../src/server.js#L3063) | `Crew.acceptInvite` |
| GET | `/v1/crew/chat` | authenticated | platform-core | [src/server.js:3007](../../src/server.js#L3007) | `readChat` |
| POST | `/v1/crew/chat` | authenticated | platform-core | [src/server.js:3006](../../src/server.js#L3006) | `postChat` |
| POST | `/v1/crew/decline/:crewId` | authenticated | social-combat | [src/server.js:3065](../../src/server.js#L3065) | `Crew.declineInvite` |
| POST | `/v1/crew/invite` | authenticated | social-combat | [src/server.js:3061](../../src/server.js#L3061) | `Crew.inviteToCrew` |
| POST | `/v1/crew/leave` | authenticated | social-combat | [src/server.js:3067](../../src/server.js#L3067) | `Crew.leaveCrew` |
| DELETE | `/v1/crew/member/:characterId` | authenticated | social-combat | [src/server.js:3070](../../src/server.js#L3070) | `Crew.kickMember` |
| POST | `/v1/crew/objective/claim` | authenticated | social-combat | [src/server.js:3096](../../src/server.js#L3096) | `Crew.claimObjective` |
| POST | `/v1/crew/recruiting` | authenticated | social-combat | [src/server.js:3082](../../src/server.js#L3082) | `Crew.setRecruiting` |
| DELETE | `/v1/crew/request/:characterId` | authenticated | social-combat | [src/server.js:3092](../../src/server.js#L3092) | `Crew.declineRequest` |
| POST | `/v1/crew/request/:characterId/accept` | authenticated | social-combat | [src/server.js:3088](../../src/server.js#L3088) | `Crew.acceptRequest` |
| POST | `/v1/crew/request/:crewId` | authenticated | social-combat | [src/server.js:3086](../../src/server.js#L3086) | `Crew.requestJoin` |
| DELETE | `/v1/crew/target` | authenticated | social-combat | [src/server.js:3078](../../src/server.js#L3078) | `Crew.clearCrewTarget` |
| POST | `/v1/crew/target` | authenticated | social-combat | [src/server.js:3076](../../src/server.js#L3076) | `Crew.setCrewTarget` |
| POST | `/v1/crimes/:id` | authenticated | platform-core | [src/server.js:1536](../../src/server.js#L1536) | `G.withCharacter` |
| GET | `/v1/daily` | authenticated | engagement-growth | [src/server.js:3220](../../src/server.js#L3220) | `W.getDaily` |
| POST | `/v1/daily/:id/claim` | authenticated | engagement-growth | [src/server.js:3225](../../src/server.js#L3225) | `W.claimDaily` |
| GET | `/v1/day` | authenticated | world-progression | [src/server.js:2414](../../src/server.js#L2414) | `Day.dayBoard` |
...
| POST | `/v1/deeds/extract` | authenticated | chain-economy | [src/server.js:3381](../../src/server.js#L3381) | `Chain.requestDeedWithdraw` |
...
| GET | `/v1/desk` | public | platform-core | [src/server.js:1653](../../src/server.js#L1653) | `Desk.deskBoard` |
| GET | `/v1/digest` | authenticated | engagement-growth | [src/server.js:3182](../../src/server.js#L3182) | `Dispatch.getDigestPrefs` |
| POST | `/v1/digest` | authenticated | engagement-growth | [src/server.js:3183](../../src/server.js#L3183) | `Dispatch.setDigestPrefs` |
| GET | `/v1/digest/confirm` | public | engagement-growth | [src/server.js:3187](../../src/server.js#L3187) | `Dispatch.confirmEmail` |
| GET | `/v1/digest/unsubscribe` | public | engagement-growth | [src/server.js:3197](../../src/server.js#L3197) | `Dispatch.unsubscribe` |
...
| GET | `/v1/discovery` | authenticated | engagement-growth | [src/server.js:3101](../../src/server.js#L3101) | `Discovery.discoveryBoard` |
| POST | `/v1/discovery/lfg` | authenticated | engagement-growth | [src/server.js:3106](../../src/server.js#L3106) | `Discovery.setLfg` |
| GET | `/v1/districts` | public | social-combat | [src/server.js:2366](../../src/server.js#L2366) | `S.onWatch` |
| POST | `/v1/districts/:id/claim` | authenticated | social-combat | [src/server.js:1742](../../src/server.js#L1742) | `S.stakeClaim` |
| POST | `/v1/districts/:id/seize` | authenticated | social-combat | [src/server.js:1728](../../src/server.js#L1728) | `S.seizeDistrict` |
| POST | `/v1/districts/:id/watch` | authenticated | social-combat | [src/server.js:1731](../../src/server.js#L1731) | `S.setWatch` |
| GET | `/v1/drop` | authenticated | engagement-growth | [src/server.js:2446](../../src/server.js#L2446) | `Drop.dropBoard` |
| POST | `/v1/drop/claim` | authenticated | engagement-growth | [src/server.js:2448](../../src/server.js#L2448) | `Drop.claimDrop` |
| POST | `/v1/drop/solana` | authenticated | engagement-growth | [src/server.js:2455](../../src/server.js#L2455) | `Drop.claimDropSolana` |
| POST | `/v1/drop/solana/challenge` | authenticated | engagement-growth | [src/server.js:2453](../../src/server.js#L2453) | `Drop.solanaChallenge` |
| GET | `/v1/duels` | authenticated | social-combat | [src/server.js:3532](../../src/server.js#L3532) | `Duels.duelBoard` |
| POST | `/v1/duels/:targetId` | authenticated | social-combat | [src/server.js:3538](../../src/server.js#L3538) | `Duels.challenge` |
| POST | `/v1/duels/list` | authenticated | social-combat | [src/server.js:3534](../../src/server.js#L3534) | `Duels.listDuel` |
| POST | `/v1/duels/style` | authenticated | social-combat | [src/server.js:3536](../../src/server.js#L3536) | `Duels.pickStyle` |
| GET | `/v1/dynasty` | authenticated | chain-economy | [src/server.js:3260](../../src/server.js#L3260) | `Dynasty.dynastyBoard` |
| POST | `/v1/dynasty/accept/:accountId` | authenticated | chain-economy | [src/server.js:3264](../../src/server.js#L3264) | `Dynasty.acceptMarriage` |
| DELETE | `/v1/dynasty/consigliere` | authenticated | chain-economy | [src/server.js:3272](../../src/server.js#L3272) | `Dynasty.endConsigliere` |
| POST | `/v1/dynasty/consigliere/:characterId` | authenticated | chain-economy | [src/server.js:3268](../../src/server.js#L3268) | `Dynasty.nameConsigliere` |
| POST | `/v1/dynasty/consigliere/accept/:accountId` | authenticated | chain-economy | [src/server.js:3270](../../src/server.js#L3270) | `Dynasty.acceptConsigliere` |
| POST | `/v1/dynasty/divorce` | authenticated | chain-economy | [src/server.js:3266](../../src/server.js#L3266) | `Dynasty.divorceMarriage` |
| POST | `/v1/dynasty/name` | authenticated | economy-ledger | [src/server.js:2220](../../src/server.js#L2220) | `Portfolio.nameDynasty` |
| POST | `/v1/dynasty/propose/:characterId` | authenticated | chain-economy | [src/server.js:3262](../../src/server.js#L3262) | `Dynasty.proposeMarriage` |
...
| GET | `/v1/events` | public | world-progression | [src/server.js:3111](../../src/server.js#L3111) | `cityEventBoard` |
| GET | `/v1/exchange` | public | platform-core | [src/server.js:2745](../../src/server.js#L2745) | — |
| DELETE | `/v1/exchange/:id` | authenticated | social-combat | [src/server.js:2752](../../src/server.js#L2752) | `S.cancelListing` |
| POST | `/v1/exchange/:id/buy` | authenticated | social-combat | [src/server.js:2754](../../src/server.js#L2754) | `S.buyListing` |
| POST | `/v1/exchange/list` | authenticated | social-combat | [src/server.js:2750](../../src/server.js#L2750) | `S.listItem` |
| GET | `/v1/explore` | authenticated | world-progression | [src/server.js:3152](../../src/server.js#L3152) | `Explore.exploreBoard` |
| GET | `/v1/fairness` | public | economy-ledger | [src/server.js:3119](../../src/server.js#L3119) | `fairnessBoard` |
| GET | `/v1/favors` | authenticated | engagement-growth | [src/server.js:3037](../../src/server.js#L3037) | `Favors.favorBoard` |
| POST | `/v1/favors` | authenticated | engagement-growth | [src/server.js:3039](../../src/server.js#L3039) | `Favors.postFavor` |
| DELETE | `/v1/favors/:id` | authenticated | engagement-growth | [src/server.js:3043](../../src/server.js#L3043) | `Favors.cancelFavor` |
| POST | `/v1/favors/:id/run` | authenticated | engagement-growth | [src/server.js:3041](../../src/server.js#L3041) | `Favors.runFavor` |
| GET | `/v1/fees/status` | authenticated | economy-ledger | [src/server.js:3405](../../src/server.js#L3405) | `Fees.feeStatus` |
| GET | `/v1/feud/:characterId` | authenticated | platform-core | [src/server.js:2669](../../src/server.js#L2669) | `G.GameError` |
| POST | `/v1/feud/:targetId/peace` | authenticated | social-combat | [src/server.js:2690](../../src/server.js#L2690) | `S.proposePeace` |
| POST | `/v1/feud/:targetId/peace/accept` | authenticated | social-combat | [src/server.js:2692](../../src/server.js#L2692) | `S.acceptPeace` |
| GET | `/v1/firsts` | authenticated | world-progression | [src/server.js:3320](../../src/server.js#L3320) | `Firsts.firstsBoard` |
| GET | `/v1/forge` | authenticated | chain-economy | [src/server.js:3409](../../src/server.js#L3409) | `Forge.forgeBoard` |
| GET | `/v1/gangs` | public | platform-core | [src/server.js:2313](../../src/server.js#L2313) | — |
| POST | `/v1/gangs` | authenticated | social-combat | [src/server.js:1688](../../src/server.js#L1688) | `S.createGang` |
| GET | `/v1/gangs/:id` | public | social-combat | [src/server.js:2330](../../src/server.js#L2330) | `S.resolveWarIfDue` |
| POST | `/v1/gangs/:id/join` | authenticated | social-combat | [src/server.js:1690](../../src/server.js#L1690) | `S.joinGang` |
| POST | `/v1/gangs/charter/:id` | authenticated | social-combat | [src/server.js:2730](../../src/server.js#L2730) | `S.chooseCharter` |
| GET | `/v1/gangs/chat` | authenticated | platform-core | [src/server.js:3005](../../src/server.js#L3005) | `readChat` |
| POST | `/v1/gangs/chat` | authenticated | platform-core | [src/server.js:3004](../../src/server.js#L3004) | `postChat` |
| POST | `/v1/gangs/contract/:targetId` | authenticated | social-combat | [src/server.js:2705](../../src/server.js#L2705) | `S.postFamilyContract` |
| POST | `/v1/gangs/contract/:targetId/:kind/cancel` | authenticated | social-combat | [src/server.js:2708](../../src/server.js#L2708) | `S.cancelFamilyContract` |
| POST | `/v1/gangs/foundation` | authenticated | engagement-growth | [src/server.js:2728](../../src/server.js#L2728) | `V.buyFoundation` |
| POST | `/v1/gangs/kick` | authenticated | social-combat | [src/server.js:1701](../../src/server.js#L1701) | `S.kickMember` |
| POST | `/v1/gangs/leave` | authenticated | social-combat | [src/server.js:1692](../../src/server.js#L1692) | `S.leaveGang` |
| POST | `/v1/gangs/portfolio/dividend` | authenticated | economy-ledger | [src/server.js:2192](../../src/server.js#L2192) | `Portfolio.claimFamilyDividend` |
| POST | `/v1/gangs/portfolio/invest` | authenticated | economy-ledger | [src/server.js:2186](../../src/server.js#L2186) | `Portfolio.familyInvest` |
| POST | `/v1/gangs/portfolio/name` | authenticated | economy-ledger | [src/server.js:2218](../../src/server.js#L2218) | `Portfolio.nameFamilyDynasty` |
| POST | `/v1/gangs/promote` | authenticated | social-combat | [src/server.js:1719](../../src/server.js#L1719) | `S.promoteMember` |
| POST | `/v1/gangs/tribute` | authenticated | social-combat | [src/server.js:1721](../../src/server.js#L1721) | `S.tribute` |
| POST | `/v1/gangs/tribute/omr` | authenticated | social-combat | [src/server.js:1724](../../src/server.js#L1724) | `S.tributeOmr` |
| POST | `/v1/gangs/vanity/color` | authenticated | engagement-growth | [src/server.js:2722](../../src/server.js#L2722) | `V.recolorGang` |
| POST | `/v1/gangs/vanity/name` | authenticated | engagement-growth | [src/server.js:2724](../../src/server.js#L2724) | `V.renameGang` |
| POST | `/v1/gangs/vanity/seal` | authenticated | engagement-growth | [src/server.js:2726](../../src/server.js#L2726) | `V.buySeal` |
| POST | `/v1/gangs/war/:targetGangId` | authenticated | social-combat | [src/server.js:1726](../../src/server.js#L1726) | `S.declareWar` |
| POST | `/v1/garage/:carId/fence` | authenticated | economy-ledger | [src/server.js:1609](../../src/server.js#L1609) | `E.fenceCar` |
| POST | `/v1/garage/:carId/melt` | authenticated | economy-ledger | [src/server.js:1605](../../src/server.js#L1605) | `E.meltCar` |
| POST | `/v1/garage/:carId/repair` | authenticated | economy-ledger | [src/server.js:1607](../../src/server.js#L1607) | `E.repairCar` |
| POST | `/v1/garage/boost` | authenticated | economy-ledger | [src/server.js:1603](../../src/server.js#L1603) | `E.boostCar` |
| POST | `/v1/gear/:id/mint` | authenticated | chain-economy | [src/server.js:1672](../../src/server.js#L1672) | `E.mintGear` |
| POST | `/v1/gear/:id/withdraw` | authenticated | chain-economy | [src/server.js:3371](../../src/server.js#L3371) | `Chain.requestGearWithdraw` |
| POST | `/v1/goods/buy` | authenticated | economy-ledger | [src/server.js:1621](../../src/server.js#L1621) | `E.buyGood` |
| POST | `/v1/goods/sell` | authenticated | economy-ledger | [src/server.js:1623](../../src/server.js#L1623) | `E.sellGood` |
| POST | `/v1/heal` | authenticated | platform-core | [src/server.js:1560](../../src/server.js#L1560) | `G.withCharacter` |
| POST | `/v1/heist` | authenticated | engagement-growth | [src/server.js:3216](../../src/server.js#L3216) | `W.heist` |
...
| GET | `/v1/home` | authenticated | engagement-growth | [src/server.js:2428](../../src/server.js#L2428) | `Home.homeBoard` |
| GET | `/v1/hustle` | authenticated | platform-core | [src/server.js:1548](../../src/server.js#L1548) | `Hustle.hustleBoard` |
| POST | `/v1/hustle/advance` | authenticated | platform-core | [src/server.js:1550](../../src/server.js#L1550) | `Hustle.advanceHustle` |
...
| POST | `/v1/identity/bio` | authenticated | engagement-growth | [src/server.js:3242](../../src/server.js#L3242) | `W.setBio` |
| POST | `/v1/identity/mint` | authenticated | chain-economy | [src/server.js:3387](../../src/server.js#L3387) | `Chain.requestDynastyMint` |
| GET | `/v1/invites` | authenticated | platform-core | [src/server.js:3051](../../src/server.js#L3051) | `Invites.inviteBoard` |
| POST | `/v1/invites` | authenticated | platform-core | [src/server.js:3055](../../src/server.js#L3055) | `Invites.issueCrewInvite` |
| POST | `/v1/items/:id/use` | authenticated | economy-ledger | [src/server.js:1617](../../src/server.js#L1617) | `E.useItem` |
...
| GET | `/v1/landmarks` | public | world-progression | [src/server.js:2243](../../src/server.js#L2243) | `Landmarks.landmarkBoard` |
| POST | `/v1/landmarks/:districtId` | authenticated | world-progression | [src/server.js:2244](../../src/server.js#L2244) | `Landmarks.dedicateLandmark` |
...
| GET | `/v1/leaderboard/contacts` | authenticated | engagement-growth | [src/server.js:3024](../../src/server.js#L3024) | `Contacts.contactsLeaderboard` |
...
| GET | `/v1/leaderboard/crews` | authenticated | social-combat | [src/server.js:3094](../../src/server.js#L3094) | `Crew.crewLeaderboard` |
...
| GET | `/v1/leaderboard/mentors` | authenticated | social-combat | [src/server.js:3133](../../src/server.js#L3133) | `Mentor.mentorLeaderboard` |
...
| GET | `/v1/leaderboard/streak` | authenticated | world-progression | [src/server.js:3140](../../src/server.js#L3140) | `Streak.streakLeaderboard` |
...
| GET | `/v1/leaderboard/vouches` | authenticated | social-combat | [src/server.js:3173](../../src/server.js#L3173) | `Vouch.vouchLeaderboard` |
...
| GET | `/v1/live` | authenticated | engagement-growth | [src/server.js:3147](../../src/server.js#L3147) | `Collision.collisionBoard` |
| GET | `/v1/loans` | authenticated | enterprise-logistics | [src/server.js:2126](../../src/server.js#L2126) | `Loans.loanBoard` |
| POST | `/v1/loans` | authenticated | enterprise-logistics | [src/server.js:2130](../../src/server.js#L2130) | `Loans.offerLoan` |
| POST | `/v1/loans/:id/buy` | authenticated | enterprise-logistics | [src/server.js:2171](../../src/server.js#L2171) | `Loans.buyPaper` |
| POST | `/v1/loans/:id/cancel` | authenticated | enterprise-logistics | [src/server.js:2134](../../src/server.js#L2134) | `Loans.cancelLoan` |
| POST | `/v1/loans/:id/collect` | authenticated | enterprise-logistics | [src/server.js:2143](../../src/server.js#L2143) | `Loans.collectLoan` |
| POST | `/v1/loans/:id/repay` | authenticated | enterprise-logistics | [src/server.js:2137](../../src/server.js#L2137) | `Loans.repayLoan` |
| POST | `/v1/loans/:id/sell` | authenticated | enterprise-logistics | [src/server.js:2149](../../src/server.js#L2149) | `Loans.sellPaper` |
| POST | `/v1/loans/:id/take` | authenticated | enterprise-logistics | [src/server.js:2132](../../src/server.js#L2132) | `Loans.takeLoan` |
| POST | `/v1/loans/:id/unsell` | authenticated | enterprise-logistics | [src/server.js:2151](../../src/server.js#L2151) | `Loans.unsellPaper` |
| POST | `/v1/loans/house` | authenticated | enterprise-logistics | [src/server.js:2155](../../src/server.js#L2155) | `Loans.takeHouseLoan` |
| POST | `/v1/loans/house/repay` | authenticated | enterprise-logistics | [src/server.js:2157](../../src/server.js#L2157) | `Loans.repayHouseLoan` |
| POST | `/v1/loans/square` | authenticated | enterprise-logistics | [src/server.js:2168](../../src/server.js#L2168) | `Loans.squareWanted` |
...
| GET | `/v1/map` | authenticated | world-progression | [src/server.js:2410](../../src/server.js#L2410) | `CityMap.cityMap` |
| GET | `/v1/market` | public | economy-ledger | [src/server.js:2283](../../src/server.js#L2283) | `Market.marketBoard` |
| POST | `/v1/market` | authenticated | economy-ledger | [src/server.js:2284](../../src/server.js#L2284) | `Market.listItem` |
| POST | `/v1/market/:id/bid` | authenticated | economy-ledger | [src/server.js:2286](../../src/server.js#L2286) | `Market.bidListing` |
| POST | `/v1/market/:id/buy` | authenticated | economy-ledger | [src/server.js:2288](../../src/server.js#L2288) | `Market.buyListing` |
| POST | `/v1/market/:id/cancel` | authenticated | economy-ledger | [src/server.js:2290](../../src/server.js#L2290) | `Market.cancelListing` |
| POST | `/v1/market/:id/claim` | authenticated | economy-ledger | [src/server.js:2298](../../src/server.js#L2298) | `Market.claimOrder` |
| POST | `/v1/market/:id/fill` | authenticated | economy-ledger | [src/server.js:2296](../../src/server.js#L2296) | `Market.fillOrder` |
| POST | `/v1/market/order` | authenticated | economy-ledger | [src/server.js:2294](../../src/server.js#L2294) | `Market.postOrder` |
| GET | `/v1/market/prices` | public | social-combat | [src/server.js:3456](../../src/server.js#L3456) | `Block.marketPrices` |
| GET | `/v1/mastery` | authenticated | world-progression | [src/server.js:2107](../../src/server.js#L2107) | `Mastery.masteryBoard` |
| POST | `/v1/mastery/trait/:trackId` | authenticated | world-progression | [src/server.js:2109](../../src/server.js#L2109) | `Mastery.chooseTrait` |
| GET | `/v1/me` | authenticated | platform-core | [src/server.js:1518](../../src/server.js#L1518) | `G.readCharacter` |
| GET | `/v1/megaproject` | authenticated | enterprise-logistics | [src/server.js:3522](../../src/server.js#L3522) | `Mega.megaBoard` |
| POST | `/v1/megaproject/cash` | authenticated | enterprise-logistics | [src/server.js:3523](../../src/server.js#L3523) | `Mega.giveCash` |
| POST | `/v1/megaproject/goods` | authenticated | enterprise-logistics | [src/server.js:3525](../../src/server.js#L3525) | `Mega.giveGoods` |
| POST | `/v1/megaproject/omr` | authenticated | enterprise-logistics | [src/server.js:3527](../../src/server.js#L3527) | `Mega.giveOmr` |
| GET | `/v1/mentor` | authenticated | social-combat | [src/server.js:3121](../../src/server.js#L3121) | `Mentor.mentorBoard` |
| POST | `/v1/mentor/accept/:mentorCharId` | authenticated | social-combat | [src/server.js:3127](../../src/server.js#L3127) | `Mentor.acceptMentor` |
| POST | `/v1/mentor/claim` | authenticated | social-combat | [src/server.js:3129](../../src/server.js#L3129) | `Mentor.claimMentor` |
| POST | `/v1/mentor/gift/:protegeCharId` | authenticated | social-combat | [src/server.js:3131](../../src/server.js#L3131) | `Mentor.mentorGift` |
| POST | `/v1/mentor/offer/:characterId` | authenticated | social-combat | [src/server.js:3125](../../src/server.js#L3125) | `Mentor.offerMentor` |
| POST | `/v1/mentor/seeking` | authenticated | social-combat | [src/server.js:3123](../../src/server.js#L3123) | `Mentor.seekMentor` |
| POST | `/v1/missions/:id` | authenticated | engagement-growth | [src/server.js:3218](../../src/server.js#L3218) | `W.doMission` |
| GET | `/v1/mod/actions` | moderator | platform-core | [src/server.js:1007](../../src/server.js#L1007) | — |
...
| GET | `/v1/mod/brokers` | moderator | platform-core | [src/server.js:2255](../../src/server.js#L2255) | `Brokers.epochBoard` |
| POST | `/v1/mod/brokers/allocate` | moderator | platform-core | [src/server.js:2256](../../src/server.js#L2256) | `Brokers.allocateEpoch` |
...
| GET | `/v1/mod/exchange` | moderator | economy-ledger | [src/server.js:1654](../../src/server.js#L1654) | `Exchange.exchangePool` |
...
| GET | `/v1/nft` | authenticated | platform-core | [src/server.js:3374](../../src/server.js#L3374) | `G.readCharacter` |
| POST | `/v1/nft/:kind/:id/upgrade` | authenticated | platform-core | [src/server.js:3375](../../src/server.js#L3375) | `G.withCharacter` |
| POST | `/v1/nft/:kind/:id/withdraw` | authenticated | chain-economy | [src/server.js:3377](../../src/server.js#L3377) | `Chain.requestItemWithdraw` |
| GET | `/v1/notifications` | authenticated | platform-core | [src/server.js:2762](../../src/server.js#L2762) | — |
| GET | `/v1/npcfamily` | authenticated | world-progression | [src/server.js:3552](../../src/server.js#L3552) | `NpcWar.warBoard` |
| POST | `/v1/npcfamily/:gangId/raid` | authenticated | world-progression | [src/server.js:3554](../../src/server.js#L3554) | `NpcWar.raidFamily` |
| POST | `/v1/npcfamily/:gangId/war` | authenticated | world-progression | [src/server.js:3559](../../src/server.js#L3559) | `NpcWar.declareNpcWar` |
| POST | `/v1/npcfamily/collect` | authenticated | world-progression | [src/server.js:3556](../../src/server.js#L3556) | `NpcWar.collectFamilyTribute` |
| GET | `/v1/onboard` | authenticated | engagement-growth | [src/server.js:3227](../../src/server.js#L3227) | `W.onboardBoard` |
| POST | `/v1/onboard/:taskId/claim` | authenticated | engagement-growth | [src/server.js:3329](../../src/server.js#L3329) | `W.claimOnboard` |
| GET | `/v1/online` | public | platform-core | [src/server.js:2881](../../src/server.js#L2881) | — |
| GET | `/v1/opportunities` | authenticated | engagement-growth | [src/server.js:2538](../../src/server.js#L2538) | `opportunityBoard` |
| GET | `/v1/paper` | authenticated | engagement-growth | [src/server.js:2523](../../src/server.js#L2523) | `People.paperBoard` |
| POST | `/v1/paper/read` | authenticated | engagement-growth | [src/server.js:2525](../../src/server.js#L2525) | `People.foldPaper` |
| GET | `/v1/pass` | authenticated | platform-core | [src/server.js:3439](../../src/server.js#L3439) | `Pass.passBoard` |
| POST | `/v1/pass/claim` | authenticated | platform-core | [src/server.js:3440](../../src/server.js#L3440) | `Pass.claimPass` |
| POST | `/v1/path` | authenticated | engagement-growth | [src/server.js:3211](../../src/server.js#L3211) | `W.choosePath` |
| POST | `/v1/path-quiz` | public | platform-core | [src/server.js:1243](../../src/server.js#L1243) | `G.track` |
| GET | `/v1/payroll` | authenticated | enterprise-logistics | [src/server.js:2420](../../src/server.js#L2420) | `Payroll.payrollBoard` |
...
| GET | `/v1/people` | authenticated | engagement-growth | [src/server.js:2517](../../src/server.js#L2517) | `People.peopleBoard` |
| GET | `/v1/people/history/:characterId` | authenticated | engagement-growth | [src/server.js:2519](../../src/server.js#L2519) | `People.pairHistory` |
| GET | `/v1/phone` | authenticated | platform-core | [src/server.js:3011](../../src/server.js#L3011) | `Phone.phoneBoard` |
| DELETE | `/v1/phone/block/:characterId` | authenticated | platform-core | [src/server.js:3018](../../src/server.js#L3018) | `Phone.unblockLine` |
| POST | `/v1/phone/block/:characterId` | authenticated | platform-core | [src/server.js:3016](../../src/server.js#L3016) | `Phone.blockLine` |
| POST | `/v1/phone/dm/:characterId` | authenticated | platform-core | [src/server.js:3014](../../src/server.js#L3014) | `Phone.sendDm` |
| GET | `/v1/phone/thread/:characterId` | authenticated | platform-core | [src/server.js:3012](../../src/server.js#L3012) | `Phone.readThread` |
| POST | `/v1/plex/mint` | authenticated | economy-ledger | [src/server.js:3417](../../src/server.js#L3417) | `Vig.payPlex` |
| GET | `/v1/plex/price` | public | economy-ledger | [src/server.js:3424](../../src/server.js#L3424) | `Vig.plexQuote` |
| POST | `/v1/plex/respawn` | authenticated | economy-ledger | [src/server.js:3419](../../src/server.js#L3419) | `Vig.payPlex` |
...
| GET | `/v1/portfolio` | authenticated | economy-ledger | [src/server.js:2182](../../src/server.js#L2182) | `Portfolio.portfolioBoard` |
| POST | `/v1/portfolio/dividend` | authenticated | economy-ledger | [src/server.js:2189](../../src/server.js#L2189) | `Portfolio.claimDividend` |
| POST | `/v1/portfolio/invest` | authenticated | economy-ledger | [src/server.js:2184](../../src/server.js#L2184) | `Portfolio.invest` |
| GET | `/v1/primetime` | authenticated | engagement-growth | [src/server.js:3157](../../src/server.js#L3157) | `Prime.primeTimeBoard` |
| POST | `/v1/primetime/answer` | authenticated | engagement-growth | [src/server.js:3159](../../src/server.js#L3159) | `Prime.answerCall` |
| POST | `/v1/primetime/round` | authenticated | engagement-growth | [src/server.js:3161](../../src/server.js#L3161) | `Prime.buyRound` |
| POST | `/v1/primetime/siege` | authenticated | engagement-growth | [src/server.js:3163](../../src/server.js#L3163) | `Prime.joinSiege` |
| GET | `/v1/profile` | authenticated | engagement-growth | [src/server.js:3238](../../src/server.js#L3238) | `W.myProfile` |
...
| GET | `/v1/provenance` | authenticated | engagement-growth | [src/server.js:2461](../../src/server.js#L2461) | `Drop.colorsBoard` |
| POST | `/v1/provenance` | authenticated | engagement-growth | [src/server.js:2463](../../src/server.js#L2463) | `Drop.claimColors` |
| POST | `/v1/push/subscribe` | authenticated | engagement-growth | [src/server.js:3176](../../src/server.js#L3176) | `Push.saveSubscription` |
| POST | `/v1/push/unsubscribe` | authenticated | engagement-growth | [src/server.js:3178](../../src/server.js#L3178) | `Push.removeSubscription` |
...
| DELETE | `/v1/rackets/:id` | authenticated | economy-ledger | [src/server.js:1637](../../src/server.js#L1637) | `E.retireRacket` |
| POST | `/v1/rackets/:id/buy` | authenticated | economy-ledger | [src/server.js:1627](../../src/server.js#L1627) | `E.buyRacket` |
| POST | `/v1/rackets/:id/upgrade` | authenticated | economy-ledger | [src/server.js:1634](../../src/server.js#L1634) | `E.upgradeRacket` |
| POST | `/v1/referral/claim` | authenticated | engagement-growth | [src/server.js:3235](../../src/server.js#L3235) | `W.claimReferral` |
| GET | `/v1/regimen` | authenticated | platform-core | [src/server.js:1541](../../src/server.js#L1541) | `RG.regimenBoard` |
| POST | `/v1/regimen/:id` | authenticated | platform-core | [src/server.js:1543](../../src/server.js#L1543) | `RG.trainDiscipline` |
| POST | `/v1/regimen/drill/:npc` | authenticated | platform-core | [src/server.js:1545](../../src/server.js#L1545) | `RG.claimDrill` |
| POST | `/v1/respec` | authenticated | engagement-growth | [src/server.js:3214](../../src/server.js#L3214) | `W.respec` |
| GET | `/v1/results` | public | platform-core | [src/server.js:3114](../../src/server.js#L3114) | — |
| GET | `/v1/rivals` | authenticated | social-combat | [src/server.js:2513](../../src/server.js#L2513) | `Rivals.rivalsBoard` |
| GET | `/v1/roster` | authenticated | social-combat | [src/server.js:1734](../../src/server.js#L1734) | `S.rosterOf` |
| DELETE | `/v1/roster/:post` | authenticated | social-combat | [src/server.js:1738](../../src/server.js#L1738) | `S.vacatePost` |
| POST | `/v1/roster/:post` | authenticated | social-combat | [src/server.js:1736](../../src/server.js#L1736) | `S.assignPost` |
| GET | `/v1/rules` | public | platform-core | [src/server.js:1756](../../src/server.js#L1756) | `jsonEtag` |
...
| POST | `/v1/safehouse` | authenticated | social-combat | [src/server.js:2702](../../src/server.js#L2702) | `S.enterSafehouse` |
| POST | `/v1/screens` | authenticated | platform-core | [src/server.js:1584](../../src/server.js#L1584) | `G.track` |
| GET | `/v1/season/recap` | authenticated | world-progression | [src/server.js:3462](../../src/server.js#L3462) | `Season.seasonRecaps` |
| GET | `/v1/seasons` | public | world-progression | [src/server.js:3460](../../src/server.js#L3460) | `Season.seasonBoard` |
| GET | `/v1/secrets` | authenticated | law-intelligence | [src/server.js:3286](../../src/server.js#L3286) | `Secrets.secretsBoard` |
| POST | `/v1/secrets/:id/expose` | authenticated | law-intelligence | [src/server.js:3306](../../src/server.js#L3306) | `Secrets.exposeSecret` |
| POST | `/v1/secrets/:id/extort` | authenticated | law-intelligence | [src/server.js:3290](../../src/server.js#L3290) | `Secrets.extortSecret` |
| POST | `/v1/secrets/:id/pay` | authenticated | law-intelligence | [src/server.js:3294](../../src/server.js#L3294) | `Secrets.payHush` |
| GET | `/v1/session` | authenticated | platform-core | [src/server.js:1523](../../src/server.js#L1523) | — |
| GET | `/v1/shipment` | authenticated | enterprise-logistics | [src/server.js:3323](../../src/server.js#L3323) | `Shipment.shipmentBoard` |
| POST | `/v1/shipment/commission/:id` | authenticated | enterprise-logistics | [src/server.js:3327](../../src/server.js#L3327) | `Shipment.commissionPiece` |
| POST | `/v1/shipment/take` | authenticated | enterprise-logistics | [src/server.js:3325](../../src/server.js#L3325) | `Shipment.takeShipment` |
| GET | `/v1/skills` | authenticated | world-progression | [src/server.js:2104](../../src/server.js#L2104) | `Skills.skillsBoard` |
| POST | `/v1/skills/:id` | authenticated | world-progression | [src/server.js:2118](../../src/server.js#L2118) | `Skills.learnSkill` |
| POST | `/v1/skills/active/:ability` | authenticated | world-progression | [src/server.js:2114](../../src/server.js#L2114) | `Skills.useActive` |
| POST | `/v1/skills/respec` | authenticated | world-progression | [src/server.js:2111](../../src/server.js#L2111) | `Skills.respecSkills` |
| POST | `/v1/skills/respec/:id` | authenticated | world-progression | [src/server.js:2116](../../src/server.js#L2116) | `Skills.respecOne` |
| GET | `/v1/social` | authenticated | engagement-growth | [src/server.js:3332](../../src/server.js#L3332) | `W.socialBoard` |
| POST | `/v1/social/:taskId/claim` | authenticated | engagement-growth | [src/server.js:3336](../../src/server.js#L3336) | `W.claimSocial` |
| GET | `/v1/soldiers` | authenticated | social-combat | [src/server.js:3275](../../src/server.js#L3275) | `Soldiers.soldierBoard` |
| DELETE | `/v1/soldiers/:id` | authenticated | social-combat | [src/server.js:3283](../../src/server.js#L3283) | `Soldiers.dismissSoldier` |
| POST | `/v1/soldiers/:id/assign` | authenticated | social-combat | [src/server.js:3279](../../src/server.js#L3279) | `Soldiers.assignSoldier` |
| POST | `/v1/soldiers/hire` | authenticated | social-combat | [src/server.js:3277](../../src/server.js#L3277) | `Soldiers.hireSoldier` |
| POST | `/v1/soldiers/unassign` | authenticated | social-combat | [src/server.js:3281](../../src/server.js#L3281) | `Soldiers.unassignSoldier` |
...
| POST | `/v1/stake` | authenticated | economy-ledger | [src/server.js:1662](../../src/server.js#L1662) | `E.stake` |
| POST | `/v1/stake/lock` | authenticated | economy-ledger | [src/server.js:1668](../../src/server.js#L1668) | `E.lockStake` |
| GET | `/v1/store` | authenticated | platform-core | [src/server.js:3431](../../src/server.js#L3431) | `Store.storeBoard` |
| POST | `/v1/store/plex/:sku` | authenticated | platform-core | [src/server.js:3433](../../src/server.js#L3433) | `Store.payPackagePlex` |
| GET | `/v1/streak` | authenticated | world-progression | [src/server.js:3136](../../src/server.js#L3136) | `Streak.streakBoard` |
| POST | `/v1/streak/claim` | authenticated | world-progression | [src/server.js:3138](../../src/server.js#L3138) | `Streak.claimStreak` |
| GET | `/v1/streets` | authenticated | platform-core | [src/server.js:2468](../../src/server.js#L2468) | — |
| POST | `/v1/streets/:targetId/boat` | authenticated | social-combat | [src/server.js:2509](../../src/server.js#L2509) | `S.stealBoat` |
| POST | `/v1/streets/:targetId/bounty` | authenticated | social-combat | [src/server.js:2527](../../src/server.js#L2527) | `S.postBounty` |
| POST | `/v1/streets/:targetId/bust` | authenticated | social-combat | [src/server.js:2741](../../src/server.js#L2741) | `S.bust` |
| POST | `/v1/streets/:targetId/fire` | authenticated | social-combat | [src/server.js:2736](../../src/server.js#L2736) | `S.fire` |
| POST | `/v1/streets/:targetId/jump` | authenticated | social-combat | [src/server.js:2500](../../src/server.js#L2500) | `S.jump` |
| POST | `/v1/streets/:targetId/npchit` | authenticated | social-combat | [src/server.js:2694](../../src/server.js#L2694) | `S.npcHit` |
| POST | `/v1/streets/:targetId/sabotage` | authenticated | social-combat | [src/server.js:2511](../../src/server.js#L2511) | `S.sabotage` |
| POST | `/v1/streets/:targetId/search` | authenticated | social-combat | [src/server.js:2732](../../src/server.js#L2732) | `S.startSearch` |
| POST | `/v1/streets/:targetId/steal` | authenticated | social-combat | [src/server.js:2504](../../src/server.js#L2504) | `S.stealCar` |
| POST | `/v1/streets/:targetId/trunk` | authenticated | social-combat | [src/server.js:2507](../../src/server.js#L2507) | `S.robTrunk` |
| DELETE | `/v1/streets/search` | authenticated | social-combat | [src/server.js:2734](../../src/server.js#L2734) | `S.callOffSearch` |
| POST | `/v1/swap` | authenticated | economy-ledger | [src/server.js:1660](../../src/server.js#L1660) | `E.swap` |
...
| POST | `/v1/train/:stat` | authenticated | platform-core | [src/server.js:1538](../../src/server.js#L1538) | `G.withCharacter` |
| POST | `/v1/travel/:district` | authenticated | platform-core | [src/server.js:1599](../../src/server.js#L1599) | `G.withCharacter` |
...
| POST | `/v1/unstake` | authenticated | economy-ledger | [src/server.js:1664](../../src/server.js#L1664) | `E.unstake` |
| POST | `/v1/vanity/name` | authenticated | engagement-growth | [src/server.js:2716](../../src/server.js#L2716) | `V.changeName` |
| POST | `/v1/vanity/plate/:carId` | authenticated | engagement-growth | [src/server.js:2720](../../src/server.js#L2720) | `V.setPlate` |
| POST | `/v1/vanity/title` | authenticated | engagement-growth | [src/server.js:2718](../../src/server.js#L2718) | `V.setTitle` |
| GET | `/v1/vault` | authenticated | economy-ledger | [src/server.js:2201](../../src/server.js#L2201) | `Treasury.vaultBoard` |
| POST | `/v1/vault/claim` | authenticated | economy-ledger | [src/server.js:2215](../../src/server.js#L2215) | `Treasury.claimVaulted` |
| DELETE | `/v1/vouch/:characterId` | authenticated | social-combat | [src/server.js:3171](../../src/server.js#L3171) | `Vouch.revokeVouch` |
| POST | `/v1/vouch/:characterId` | authenticated | social-combat | [src/server.js:3169](../../src/server.js#L3169) | `Vouch.giveVouch` |
| GET | `/v1/vouches` | authenticated | social-combat | [src/server.js:3167](../../src/server.js#L3167) | `Vouch.vouchBoard` |
| GET | `/v1/wage` | authenticated | economy-ledger | [src/server.js:3245](../../src/server.js#L3245) | `Emission.wageBoard` |
| POST | `/v1/wallet` | authenticated | chain-economy | [src/server.js:3341](../../src/server.js#L3341) | `G.GameError` |
| POST | `/v1/wallet/challenge` | authenticated | chain-economy | [src/server.js:3362](../../src/server.js#L3362) | `Chain.walletChallenge` |
| POST | `/v1/wallet/verify` | authenticated | chain-economy | [src/server.js:3363](../../src/server.js#L3363) | `Chain.walletVerify` |
| GET | `/v1/window` | authenticated | economy-ledger | [src/server.js:1648](../../src/server.js#L1648) | `Exchange.exchangeBoard` |
| POST | `/v1/window/redeem` | authenticated | economy-ledger | [src/server.js:1650](../../src/server.js#L1650) | `Exchange.redeem` |
| GET | `/v1/wire` | authenticated | law-intelligence | [src/server.js:2259](../../src/server.js#L2259) | `Wire.wireBoard` |
| POST | `/v1/wire/dig/:targetId` | authenticated | law-intelligence | [src/server.js:3288](../../src/server.js#L3288) | `Secrets.digSecret` |
| POST | `/v1/wire/disinfo` | authenticated | law-intelligence | [src/server.js:2277](../../src/server.js#L2277) | `Wire.plantDisinfo` |
| POST | `/v1/wire/dossier/:targetId` | authenticated | law-intelligence | [src/server.js:2275](../../src/server.js#L2275) | `Wire.pullDossier` |
| POST | `/v1/wire/informant/:targetId` | authenticated | law-intelligence | [src/server.js:2279](../../src/server.js#L2279) | `Wire.recruitInformant` |
| POST | `/v1/wire/subscribe` | authenticated | law-intelligence | [src/server.js:2265](../../src/server.js#L2265) | `Wire.subscribeWire` |
| POST | `/v1/wire/sweep` | authenticated | law-intelligence | [src/server.js:2263](../../src/server.js#L2263) | `Wire.sweepBugs` |
| POST | `/v1/wire/tap/:targetId` | authenticated | law-intelligence | [src/server.js:2261](../../src/server.js#L2261) | `Wire.placeTap` |
| POST | `/v1/wire/trace` | authenticated | law-intelligence | [src/server.js:2273](../../src/server.js#L2273) | `Wire.traceBugs` |
| DELETE | `/v1/wire/watch/:targetId` | authenticated | law-intelligence | [src/server.js:2270](../../src/server.js#L2270) | `Wire.cancelWatch` |
| POST | `/v1/wire/watch/:targetId` | authenticated | law-intelligence | [src/server.js:2268](../../src/server.js#L2268) | `Wire.enrollWatch` |
| POST | `/v1/withdraw` | authenticated | chain-economy | [src/server.js:3365](../../src/server.js#L3365) | `Chain.requestWithdraw` |
| POST | `/v1/withdraw/:id/cancel` | authenticated | chain-economy | [src/server.js:3369](../../src/server.js#L3369) | `Chain.cancelQueuedWithdraw` |
| GET | `/v1/withdraw/status` | authenticated | chain-economy | [src/server.js:3389](../../src/server.js#L3389) | `Chain.reserveStatus` |
| POST | `/v1/workshop/ammo` | authenticated | economy-ledger | [src/server.js:1615](../../src/server.js#L1615) | `E.craftAmmo` |
| POST | `/v1/workshop/craft/:id` | authenticated | economy-ledger | [src/server.js:1613](../../src/server.js#L1613) | `E.craft` |
| GET | `/v1/world` | authenticated | world-progression | [src/server.js:3547](../../src/server.js#L3547) | `World.worldBoard` |
| POST | `/v1/world/:npcId/invade` | authenticated | world-progression | [src/server.js:3577](../../src/server.js#L3577) | `World.invadeOutpost` |
| POST | `/v1/world/:npcId/plan` | authenticated | world-progression | [src/server.js:3563](../../src/server.js#L3563) | `World.planRaid` |
| POST | `/v1/world/:npcId/raid` | authenticated | world-progression | [src/server.js:3549](../../src/server.js#L3549) | `World.raidNpc` |
| POST | `/v1/world/:npcId/reinforce` | authenticated | world-progression | [src/server.js:3580](../../src/server.js#L3580) | `World.reinforceOutpost` |
| POST | `/v1/world/collect` | authenticated | world-progression | [src/server.js:3575](../../src/server.js#L3575) | `World.collectFrontier` |
| GET | `/v1/world/raids` | authenticated | world-progression | [src/server.js:3561](../../src/server.js#L3561) | `World.raidBoard` |
| POST | `/v1/world/raids/:id/dismiss` | authenticated | world-progression | [src/server.js:3569](../../src/server.js#L3569) | `World.dismissGun` |
| POST | `/v1/world/raids/:id/go` | authenticated | world-progression | [src/server.js:3573](../../src/server.js#L3573) | `World.executeRaid` |
| POST | `/v1/world/raids/:id/hire` | authenticated | world-progression | [src/server.js:3567](../../src/server.js#L3567) | `World.hireRaid` |
| POST | `/v1/world/raids/:id/join` | authenticated | world-progression | [src/server.js:3565](../../src/server.js#L3565) | `World.joinRaid` |
| POST | `/v1/world/raids/:id/leave` | authenticated | world-progression | [src/server.js:3571](../../src/server.js#L3571) | `World.leaveRaid` |
...
| GET | `/v1/ws` | token-query | platform-core | [src/server.js:2785](../../src/server.js#L2785) | — |
| GET | `/v1/yield` | public | economy-ledger | [src/server.js:1652](../../src/server.js#L1652) | `Exchange.yieldBoard` |
