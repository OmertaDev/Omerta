...
| POST | `/v1/agent/act` | authenticated | platform-core | [src/server.js:2367](../../src/server.js#L2367) | `G.GameError` |
| GET | `/v1/agent/turn` | authenticated | economy-ledger | [src/server.js:2308](../../src/server.js#L2308) | `Market.fillOrder` |
...
| POST | `/v1/character` | authenticated | platform-core | [src/server.js:1217](../../src/server.js#L1217) | `G.cleanText` |
...
| GET | `/v1/chat` | authenticated | platform-core | [src/server.js:2749](../../src/server.js#L2749) | — |
| POST | `/v1/chat` | authenticated | platform-core | [src/server.js:2748](../../src/server.js#L2748) | — |
...
| GET | `/v1/city` | public | platform-core | [src/server.js:3198](../../src/server.js#L3198) | `Commission.tickerBallotBoard` |
...
| GET | `/v1/crew/chat` | authenticated | platform-core | [src/server.js:2753](../../src/server.js#L2753) | — |
| POST | `/v1/crew/chat` | authenticated | platform-core | [src/server.js:2752](../../src/server.js#L2752) | — |
...
| GET | `/v1/gangs/chat` | authenticated | platform-core | [src/server.js:2751](../../src/server.js#L2751) | — |
| POST | `/v1/gangs/chat` | authenticated | platform-core | [src/server.js:2750](../../src/server.js#L2750) | — |
...
| GET | `/v1/opportunities` | authenticated | engagement-growth | [src/server.js:2292](../../src/server.js#L2292) | `G.readCharacter` |
...
| GET | `/v1/rules` | public | platform-core | [src/server.js:1518](../../src/server.js#L1518) | — |
