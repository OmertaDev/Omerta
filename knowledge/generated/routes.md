...
> 792 literal registrations extracted from `src/server.js` and `src/routes/`. Runtime authority remains `GET /openapi.json`.
...
|---|---|---|---|---|---|
| GET | `/` | public | client-experience | [src/server.js:475](../../src/server.js#L475) | `serveLaunchPage` |
| GET | `/admin` | public | client-experience | [src/server.js:481](../../src/server.js#L481) | `servePage` |
| GET | `/agents` | public | client-experience | [src/server.js:745](../../src/server.js#L745) | — |
| GET | `/AGENTS.md` | public | client-experience | [src/server.js:746](../../src/server.js#L746) | — |
| GET | `/arena` | public | client-experience | [src/server.js:491](../../src/server.js#L491) | `servePage` |
| GET | `/art/:file` | public | client-experience | [src/server.js:594](../../src/server.js#L594) | `sendVideo` |
| GET | `/art/hype/:file` | public | client-experience | [src/server.js:600](../../src/server.js#L600) | `sendVideo` |
| GET | `/beef/:a/:b` | public | client-experience | [src/server.js:735](../../src/server.js#L735) | `Cards.beefDossier` |
| GET | `/card/:type/:name` | public | client-experience | [src/server.js:699](../../src/server.js#L699) | `Cards.publicDossier` |
| GET | `/card/beef/:a/:b` | public | client-experience | [src/server.js:715](../../src/server.js#L715) | `Cards.beefDossier` |
| GET | `/deed/:tokenId` | public | client-experience | [src/server.js:684](../../src/server.js#L684) | `Deeds.deedByToken` |
| GET | `/favicon.ico` | public | client-experience | [src/server.js:540](../../src/server.js#L540) | — |
| GET | `/health` | public | client-experience | [src/server.js:918](../../src/server.js#L918) | — |
| GET | `/llms.txt` | public | client-experience | [src/server.js:747](../../src/server.js#L747) | — |
| GET | `/manifest.json` | public | client-experience | [src/server.js:525](../../src/server.js#L525) | — |
| GET | `/manifest.webmanifest` | public | client-experience | [src/server.js:526](../../src/server.js#L526) | — |
| GET | `/omerta-ui.css` | public | client-experience | [src/server.js:513](../../src/server.js#L513) | — |
| GET | `/openapi.json` | public | client-experience | [src/server.js:763](../../src/server.js#L763) | — |
| GET | `/path` | public | client-experience | [src/server.js:500](../../src/server.js#L500) | `servePage` |
| GET | `/path/:id` | public | client-experience | [src/server.js:502](../../src/server.js#L502) | — |
| GET | `/play` | public | client-experience | [src/server.js:496](../../src/server.js#L496) | `servePage` |
| GET | `/robots.txt` | public | client-experience | [src/server.js:751](../../src/server.js#L751) | — |
| GET | `/sitemap.xml` | public | client-experience | [src/server.js:756](../../src/server.js#L756) | — |
| GET | `/sw.js` | public | client-experience | [src/server.js:518](../../src/server.js#L518) | — |
| GET | `/u/:name` | public | client-experience | [src/server.js:729](../../src/server.js#L729) | `Cards.publicDossier` |
| POST | `/v1/access/logout` | public | platform-core | [src/server.js:1301](../../src/server.js#L1301) | — |
| POST | `/v1/access/redeem` | public | platform-core | [src/server.js:1285](../../src/server.js#L1285) | `G.GameError` |
| POST | `/v1/access/session` | authenticated | platform-core | [src/server.js:1294](../../src/server.js#L1294) | — |
| POST | `/v1/agent/act` | authenticated | platform-core | [src/server.js:2580](../../src/server.js#L2580) | `executeAgentAction` |
| GET | `/v1/agent/turn` | authenticated | platform-core | [src/server.js:2521](../../src/server.js#L2521) | `readAgentTurn` |
| GET | `/v1/arena` | public | engagement-growth | [src/server.js:2632](../../src/server.js#L2632) | `arenaBoard` |
| POST | `/v1/armory/ammo` | authenticated | economy-ledger | [src/server.js:1655](../../src/server.js#L1655) | `E.buyAmmo` |
| POST | `/v1/armory/gun/:id/buy` | authenticated | economy-ledger | [src/server.js:1647](../../src/server.js#L1647) | `E.buyGun` |
| POST | `/v1/armory/gun/:id/equip` | authenticated | economy-ledger | [src/server.js:1649](../../src/server.js#L1649) | `E.equipGun` |
| POST | `/v1/armory/unequip` | authenticated | economy-ledger | [src/server.js:1651](../../src/server.js#L1651) | `E.equipGun` |
| POST | `/v1/armory/vest/:id` | authenticated | economy-ledger | [src/server.js:1653](../../src/server.js#L1653) | `E.buyVest` |
| GET | `/v1/art/:kind/:id` | public | platform-core | [src/server.js:616](../../src/server.js#L616) | — |
| GET | `/v1/art/motion` | public | platform-core | [src/server.js:605](../../src/server.js#L605) | — |
| POST | `/v1/assets/:id/buy` | authenticated | economy-ledger | [src/server.js:1600](../../src/server.js#L1600) | `E.buyAsset` |
| POST | `/v1/assets/:id/sell` | authenticated | economy-ledger | [src/server.js:1602](../../src/server.js#L1602) | `E.sellAsset` |
| GET | `/v1/auction` | authenticated | platform-core | [src/server.js:2197](../../src/server.js#L2197) | `Auction.auctionBoard` |
| POST | `/v1/auction/:lotId/bid` | authenticated | platform-core | [src/server.js:2199](../../src/server.js#L2199) | `Auction.bidAuction` |
| POST | `/v1/auction/consign` | authenticated | platform-core | [src/server.js:2202](../../src/server.js#L2202) | `Auction.consignTrophy` |
| POST | `/v1/auction/consign/:id/bid` | authenticated | platform-core | [src/server.js:2204](../../src/server.js#L2204) | `Auction.bidConsignment` |
| POST | `/v1/auction/consign/:id/cancel` | authenticated | platform-core | [src/server.js:2206](../../src/server.js#L2206) | `Auction.reclaimConsignment` |
| POST | `/v1/auth/agent-key` | authenticated | platform-core | [src/server.js:1392](../../src/server.js#L1392) | `A.acknowledgeGuestBootstrap` |
| POST | `/v1/auth/guest` | public | platform-core | [src/server.js:1284](../../src/server.js#L1284) | — |
| POST | `/v1/auth/guest/bootstrap/ack` | authenticated | platform-core | [src/server.js:1305](../../src/server.js#L1305) | `A.acknowledgeGuestBootstrap` |
| POST | `/v1/auth/logout-all` | authenticated | platform-core | [src/server.js:1402](../../src/server.js#L1402) | — |
| POST | `/v1/auth/privy` | public | platform-core | [src/server.js:1315](../../src/server.js#L1315) | `providerLogin` |
| POST | `/v1/auth/upgrade` | authenticated | platform-core | [src/server.js:1383](../../src/server.js#L1383) | `A.upgradeAccount` |
| POST | `/v1/auth/x` | public | platform-core | [src/server.js:1314](../../src/server.js#L1314) | `providerLogin` |
| GET | `/v1/auth/x/callback` | public | platform-core | [src/server.js:1357](../../src/server.js#L1357) | `A.xOAuthCallback` |
| POST | `/v1/auth/x/start` | public | platform-core | [src/server.js:1325](../../src/server.js#L1325) | `A.upgradeAccount` |
| GET | `/v1/avatar/:seed` | public | platform-core | [src/server.js:631](../../src/server.js#L631) | — |
| GET | `/v1/bank` | authenticated | platform-core | [src/server.js:2177](../../src/server.js#L2177) | `Bank.bankBoard` |
| POST | `/v1/bank/:dir` | authenticated | platform-core | [src/server.js:1568](../../src/server.js#L1568) | `G.withCharacter` |
| GET | `/v1/block` | authenticated | social-combat | [src/server.js:2403](../../src/server.js#L2403) | `Block.streetsBoard` |
| GET | `/v1/bloodline` | authenticated | platform-core | [src/server.js:3221](../../src/server.js#L3221) | `Bloodline.bloodlineBoard` |
| POST | `/v1/bodyguard/hire/:guardId` | authenticated | social-combat | [src/server.js:2680](../../src/server.js#L2680) | `S.hireBodyguard` |
| POST | `/v1/bodyguard/offer` | authenticated | social-combat | [src/server.js:2678](../../src/server.js#L2678) | `S.offerBodyguard` |
| POST | `/v1/bond/calldata` | authenticated | chain-economy | [src/server.js:3322](../../src/server.js#L3322) | `Chain.bondCalldata` |
| POST | `/v1/bond/quote` | authenticated | chain-economy | [src/server.js:3319](../../src/server.js#L3319) | `Chain.quoteBond` |
| GET | `/v1/bonds` | authenticated | platform-core | [src/server.js:3311](../../src/server.js#L3311) | `Bonds.bondBoard` |
| POST | `/v1/bonds/:id/claim` | authenticated | platform-core | [src/server.js:3312](../../src/server.js#L3312) | `Bonds.claimBond` |
| POST | `/v1/bonds/charter` | authenticated | platform-core | [src/server.js:3317](../../src/server.js#L3317) | `Bonds.commissionCharter` |
| POST | `/v1/bonds/pledge` | authenticated | platform-core | [src/server.js:3315](../../src/server.js#L3315) | `Bonds.pledgeTreasury` |
...
| POST | `/v1/broadcast/shared` | authenticated | platform-core | [src/server.js:1537](../../src/server.js#L1537) | `G.track` |
| GET | `/v1/brokers` | authenticated | platform-core | [src/server.js:2218](../../src/server.js#L2218) | `Brokers.brokerBoard` |
| POST | `/v1/brokers/activate` | authenticated | platform-core | [src/server.js:2220](../../src/server.js#L2220) | `Brokers.activate` |
| GET | `/v1/bulletin` | authenticated | engagement-growth | [src/server.js:3475](../../src/server.js#L3475) | `bulletinBoard` |
| POST | `/v1/bulletin/claim` | authenticated | platform-core | [src/server.js:3480](../../src/server.js#L3480) | `G.withCharacter` |
| GET | `/v1/business` | authenticated | enterprise-logistics | [src/server.js:2040](../../src/server.js#L2040) | `Business.businessesOf` |
| DELETE | `/v1/business/:id` | authenticated | enterprise-logistics | [src/server.js:2012](../../src/server.js#L2012) | `Business.shutterBusiness` |
| POST | `/v1/business/:id/launder` | authenticated | enterprise-logistics | [src/server.js:2014](../../src/server.js#L2014) | `Business.launderAtBusiness` |
| POST | `/v1/business/:id/rob` | authenticated | enterprise-logistics | [src/server.js:2025](../../src/server.js#L2025) | `Business.robBusiness` |
| POST | `/v1/business/:id/shakedown` | authenticated | enterprise-logistics | [src/server.js:2018](../../src/server.js#L2018) | `Business.shakedownBusiness` |
| POST | `/v1/business/:id/specialize` | authenticated | enterprise-logistics | [src/server.js:2032](../../src/server.js#L2032) | `Business.specializeBusiness` |
| POST | `/v1/business/:id/takeover` | authenticated | enterprise-logistics | [src/server.js:2034](../../src/server.js#L2034) | `Business.takeoverBusiness` |
| POST | `/v1/business/:id/upgrade` | authenticated | enterprise-logistics | [src/server.js:2007](../../src/server.js#L2007) | `Business.upgradeBusiness` |
| POST | `/v1/business/:kind/buy` | authenticated | enterprise-logistics | [src/server.js:1999](../../src/server.js#L1999) | `Business.buyBusiness` |
| POST | `/v1/business/collect` | authenticated | enterprise-logistics | [src/server.js:2001](../../src/server.js#L2001) | `Business.collectBusiness` |
| POST | `/v1/business/upkeep` | authenticated | enterprise-logistics | [src/server.js:2005](../../src/server.js#L2005) | `Business.payBusinessUpkeep` |
| POST | `/v1/call/fulfill` | authenticated | engagement-growth | [src/server.js:2990](../../src/server.js#L2990) | `Contacts.fulfillCall` |
| GET | `/v1/campaigns` | authenticated | platform-core | [src/server.js:3213](../../src/server.js#L3213) | `Campaigns.campaignBoard` |
| POST | `/v1/campaigns/:id/choose` | authenticated | platform-core | [src/server.js:3217](../../src/server.js#L3217) | `Campaigns.chooseCampaign` |
| POST | `/v1/campaigns/:id/claim` | authenticated | platform-core | [src/server.js:3219](../../src/server.js#L3219) | `Campaigns.claimCampaign` |
| POST | `/v1/campaigns/:id/start` | authenticated | platform-core | [src/server.js:3215](../../src/server.js#L3215) | `Campaigns.startCampaign` |
| GET | `/v1/capo` | authenticated | engagement-growth | [src/routes/leaderboards.js:88](../../src/routes/leaderboards.js#L88) | `W.capoBoard` |
| GET | `/v1/career` | authenticated | engagement-growth | [src/server.js:3193](../../src/server.js#L3193) | `Career.careerBoard` |
| POST | `/v1/career/:taskId` | authenticated | engagement-growth | [src/server.js:3195](../../src/server.js#L3195) | `Career.claimCareer` |
...
| GET | `/v1/catalog` | public | enterprise-logistics | [src/server.js:1720](../../src/server.js#L1720) | `Business.catalog` |
| POST | `/v1/character` | authenticated | platform-core | [src/server.js:1416](../../src/server.js#L1416) | `Store.claimPendingWire` |
| POST | `/v1/character/forge` | authenticated | chain-economy | [src/server.js:3373](../../src/server.js#L3373) | `Forge.forgeCharacter` |
| POST | `/v1/character/mint` | authenticated | economy-ledger | [src/server.js:3364](../../src/server.js#L3364) | `Fees.mintCharacter` |
| POST | `/v1/character/reroll` | authenticated | economy-ledger | [src/server.js:3367](../../src/server.js#L3367) | `Fees.rerollCharacter` |
| GET | `/v1/chat` | authenticated | platform-core | [src/server.js:2966](../../src/server.js#L2966) | `readChat` |
| POST | `/v1/chat` | authenticated | platform-core | [src/server.js:2965](../../src/server.js#L2965) | `postChat` |
| POST | `/v1/checkin` | authenticated | platform-core | [src/server.js:1533](../../src/server.js#L1533) | `G.withCharacter` |
| GET | `/v1/circle` | authenticated | engagement-growth | [src/server.js:3105](../../src/server.js#L3105) | `Circle.circleBoard` |
| GET | `/v1/city` | public | platform-core | [src/server.js:3430](../../src/server.js#L3430) | — |
| GET | `/v1/citywide` | authenticated | world-progression | [src/server.js:2407](../../src/server.js#L2407) | `Citywide.citywideBoard` |
| POST | `/v1/claim-rewards` | authenticated | economy-ledger | [src/server.js:1641](../../src/server.js#L1641) | `E.claimRewards` |
| GET | `/v1/clues` | authenticated | platform-core | [src/server.js:3506](../../src/server.js#L3506) | `Clues.clueBoard` |
| POST | `/v1/clues/dig` | authenticated | platform-core | [src/server.js:3508](../../src/server.js#L3508) | `Clues.dig` |
| GET | `/v1/collection` | authenticated | law-intelligence | [src/server.js:3280](../../src/server.js#L3280) | `Collection.collectionBoard` |
| GET | `/v1/commission` | public | platform-core | [src/server.js:2056](../../src/server.js#L2056) | `Commission.commissionBoard` |
| POST | `/v1/commission/override` | authenticated | platform-core | [src/server.js:2065](../../src/server.js#L2065) | `Commission.overrideVeto` |
| POST | `/v1/commission/propose` | authenticated | platform-core | [src/server.js:2062](../../src/server.js#L2062) | `Commission.proposeDecree` |
| GET | `/v1/commission/ticker` | public | platform-core | [src/server.js:2070](../../src/server.js#L2070) | `Commission.tickerBallotBoard` |
| POST | `/v1/commission/ticker` | authenticated | platform-core | [src/server.js:2071](../../src/server.js#L2071) | `Commission.castTickerVote` |
| POST | `/v1/commission/veto` | authenticated | platform-core | [src/server.js:2059](../../src/server.js#L2059) | `Commission.vetoDecree` |
| POST | `/v1/commission/vote` | authenticated | platform-core | [src/server.js:2057](../../src/server.js#L2057) | `Commission.castVote` |
| GET | `/v1/contacts` | authenticated | engagement-growth | [src/server.js:2984](../../src/server.js#L2984) | `Contacts.contactsBoard` |
...
| GET | `/v1/contracts` | authenticated | social-combat | [src/server.js:2499](../../src/server.js#L2499) | `S.listContracts` |
| POST | `/v1/contracts/:targetId/:kind/cancel` | authenticated | social-combat | [src/server.js:2503](../../src/server.js#L2503) | `S.cancelBounty` |
| POST | `/v1/contracts/peek` | authenticated | social-combat | [src/server.js:2501](../../src/server.js#L2501) | `S.peekContracts` |
...
| GET | `/v1/convoys` | authenticated | enterprise-logistics | [src/server.js:2269](../../src/server.js#L2269) | `Convoy.convoyBoard` |
...
| GET | `/v1/corner` | authenticated | platform-core | [src/server.js:1525](../../src/server.js#L1525) | `Corner.cornerBoard` |
| POST | `/v1/corner/:slot/accept` | authenticated | platform-core | [src/server.js:1527](../../src/server.js#L1527) | `Corner.acceptCorner` |
| POST | `/v1/corner/:slot/claim` | authenticated | platform-core | [src/server.js:1529](../../src/server.js#L1529) | `Corner.claimCorner` |
| GET | `/v1/crew` | authenticated | social-combat | [src/server.js:3012](../../src/server.js#L3012) | `Crew.crewBoard` |
| POST | `/v1/crew` | authenticated | social-combat | [src/server.js:3022](../../src/server.js#L3022) | `Crew.createCrew` |
| POST | `/v1/crew/accept/:crewId` | authenticated | social-combat | [src/server.js:3026](../../src/server.js#L3026) | `Crew.acceptInvite` |
| GET | `/v1/crew/chat` | authenticated | platform-core | [src/server.js:2970](../../src/server.js#L2970) | `readChat` |
| POST | `/v1/crew/chat` | authenticated | platform-core | [src/server.js:2969](../../src/server.js#L2969) | `postChat` |
| POST | `/v1/crew/decline/:crewId` | authenticated | social-combat | [src/server.js:3028](../../src/server.js#L3028) | `Crew.declineInvite` |
| POST | `/v1/crew/invite` | authenticated | social-combat | [src/server.js:3024](../../src/server.js#L3024) | `Crew.inviteToCrew` |
| POST | `/v1/crew/leave` | authenticated | social-combat | [src/server.js:3030](../../src/server.js#L3030) | `Crew.leaveCrew` |
| DELETE | `/v1/crew/member/:characterId` | authenticated | social-combat | [src/server.js:3033](../../src/server.js#L3033) | `Crew.kickMember` |
| POST | `/v1/crew/objective/claim` | authenticated | social-combat | [src/server.js:3059](../../src/server.js#L3059) | `Crew.claimObjective` |
| POST | `/v1/crew/recruiting` | authenticated | social-combat | [src/server.js:3045](../../src/server.js#L3045) | `Crew.setRecruiting` |
| DELETE | `/v1/crew/request/:characterId` | authenticated | social-combat | [src/server.js:3055](../../src/server.js#L3055) | `Crew.declineRequest` |
| POST | `/v1/crew/request/:characterId/accept` | authenticated | social-combat | [src/server.js:3051](../../src/server.js#L3051) | `Crew.acceptRequest` |
| POST | `/v1/crew/request/:crewId` | authenticated | social-combat | [src/server.js:3049](../../src/server.js#L3049) | `Crew.requestJoin` |
| DELETE | `/v1/crew/target` | authenticated | social-combat | [src/server.js:3041](../../src/server.js#L3041) | `Crew.clearCrewTarget` |
| POST | `/v1/crew/target` | authenticated | social-combat | [src/server.js:3039](../../src/server.js#L3039) | `Crew.setCrewTarget` |
| POST | `/v1/crimes/:id` | authenticated | platform-core | [src/server.js:1507](../../src/server.js#L1507) | `G.withCharacter` |
| GET | `/v1/daily` | authenticated | engagement-growth | [src/server.js:3183](../../src/server.js#L3183) | `W.getDaily` |
| POST | `/v1/daily/:id/claim` | authenticated | engagement-growth | [src/server.js:3188](../../src/server.js#L3188) | `W.claimDaily` |
| GET | `/v1/day` | authenticated | world-progression | [src/server.js:2381](../../src/server.js#L2381) | `Day.dayBoard` |
...
| POST | `/v1/deeds/extract` | authenticated | chain-economy | [src/server.js:3344](../../src/server.js#L3344) | `Chain.requestDeedWithdraw` |
| POST | `/v1/deeds/list` | authenticated | enterprise-logistics | [src/routes/deeds.js:21](../../src/routes/deeds.js#L21) | `Deeds.listDeed` |
| GET | `/v1/deeds/plate/:tokenId` | public | enterprise-logistics | [src/server.js:676](../../src/server.js#L676) | `Deeds.deedByToken` |
...
| GET | `/v1/desk` | public | platform-core | [src/server.js:1624](../../src/server.js#L1624) | `Desk.deskBoard` |
| GET | `/v1/digest` | authenticated | engagement-growth | [src/server.js:3145](../../src/server.js#L3145) | `Dispatch.getDigestPrefs` |
| POST | `/v1/digest` | authenticated | engagement-growth | [src/server.js:3146](../../src/server.js#L3146) | `Dispatch.setDigestPrefs` |
| GET | `/v1/digest/confirm` | public | engagement-growth | [src/server.js:3150](../../src/server.js#L3150) | `Dispatch.confirmEmail` |
| GET | `/v1/digest/unsubscribe` | public | engagement-growth | [src/server.js:3160](../../src/server.js#L3160) | `Dispatch.unsubscribe` |
...
| GET | `/v1/discovery` | authenticated | engagement-growth | [src/server.js:3064](../../src/server.js#L3064) | `Discovery.discoveryBoard` |
| POST | `/v1/discovery/lfg` | authenticated | engagement-growth | [src/server.js:3069](../../src/server.js#L3069) | `Discovery.setLfg` |
| GET | `/v1/districts` | public | social-combat | [src/server.js:2333](../../src/server.js#L2333) | `S.onWatch` |
| POST | `/v1/districts/:id/claim` | authenticated | social-combat | [src/server.js:1713](../../src/server.js#L1713) | `S.stakeClaim` |
| POST | `/v1/districts/:id/seize` | authenticated | social-combat | [src/server.js:1699](../../src/server.js#L1699) | `S.seizeDistrict` |
| POST | `/v1/districts/:id/watch` | authenticated | social-combat | [src/server.js:1702](../../src/server.js#L1702) | `S.setWatch` |
| GET | `/v1/drop` | authenticated | engagement-growth | [src/server.js:2413](../../src/server.js#L2413) | `Drop.dropBoard` |
| POST | `/v1/drop/claim` | authenticated | engagement-growth | [src/server.js:2415](../../src/server.js#L2415) | `Drop.claimDrop` |
| POST | `/v1/drop/solana` | authenticated | engagement-growth | [src/server.js:2422](../../src/server.js#L2422) | `Drop.claimDropSolana` |
| POST | `/v1/drop/solana/challenge` | authenticated | engagement-growth | [src/server.js:2420](../../src/server.js#L2420) | `Drop.solanaChallenge` |
| GET | `/v1/duels` | authenticated | social-combat | [src/server.js:3495](../../src/server.js#L3495) | `Duels.duelBoard` |
| POST | `/v1/duels/:targetId` | authenticated | social-combat | [src/server.js:3501](../../src/server.js#L3501) | `Duels.challenge` |
| POST | `/v1/duels/list` | authenticated | social-combat | [src/server.js:3497](../../src/server.js#L3497) | `Duels.listDuel` |
| POST | `/v1/duels/style` | authenticated | social-combat | [src/server.js:3499](../../src/server.js#L3499) | `Duels.pickStyle` |
| GET | `/v1/dynasty` | authenticated | chain-economy | [src/server.js:3223](../../src/server.js#L3223) | `Dynasty.dynastyBoard` |
| POST | `/v1/dynasty/accept/:accountId` | authenticated | chain-economy | [src/server.js:3227](../../src/server.js#L3227) | `Dynasty.acceptMarriage` |
| DELETE | `/v1/dynasty/consigliere` | authenticated | chain-economy | [src/server.js:3235](../../src/server.js#L3235) | `Dynasty.endConsigliere` |
| POST | `/v1/dynasty/consigliere/:characterId` | authenticated | chain-economy | [src/server.js:3231](../../src/server.js#L3231) | `Dynasty.nameConsigliere` |
| POST | `/v1/dynasty/consigliere/accept/:accountId` | authenticated | chain-economy | [src/server.js:3233](../../src/server.js#L3233) | `Dynasty.acceptConsigliere` |
| POST | `/v1/dynasty/divorce` | authenticated | chain-economy | [src/server.js:3229](../../src/server.js#L3229) | `Dynasty.divorceMarriage` |
| POST | `/v1/dynasty/name` | authenticated | economy-ledger | [src/server.js:2187](../../src/server.js#L2187) | `Portfolio.nameDynasty` |
| POST | `/v1/dynasty/propose/:characterId` | authenticated | chain-economy | [src/server.js:3225](../../src/server.js#L3225) | `Dynasty.proposeMarriage` |
...
| GET | `/v1/events` | public | world-progression | [src/server.js:3074](../../src/server.js#L3074) | `cityEventBoard` |
| GET | `/v1/exchange` | public | platform-core | [src/server.js:2712](../../src/server.js#L2712) | — |
| DELETE | `/v1/exchange/:id` | authenticated | social-combat | [src/server.js:2719](../../src/server.js#L2719) | `S.cancelListing` |
| POST | `/v1/exchange/:id/buy` | authenticated | social-combat | [src/server.js:2721](../../src/server.js#L2721) | `S.buyListing` |
| POST | `/v1/exchange/list` | authenticated | social-combat | [src/server.js:2717](../../src/server.js#L2717) | `S.listItem` |
| GET | `/v1/explore` | authenticated | world-progression | [src/server.js:3115](../../src/server.js#L3115) | `Explore.exploreBoard` |
| GET | `/v1/fairness` | public | economy-ledger | [src/server.js:3082](../../src/server.js#L3082) | `fairnessBoard` |
| GET | `/v1/favors` | authenticated | engagement-growth | [src/server.js:3000](../../src/server.js#L3000) | `Favors.favorBoard` |
| POST | `/v1/favors` | authenticated | engagement-growth | [src/server.js:3002](../../src/server.js#L3002) | `Favors.postFavor` |
| DELETE | `/v1/favors/:id` | authenticated | engagement-growth | [src/server.js:3006](../../src/server.js#L3006) | `Favors.cancelFavor` |
| POST | `/v1/favors/:id/run` | authenticated | engagement-growth | [src/server.js:3004](../../src/server.js#L3004) | `Favors.runFavor` |
| GET | `/v1/fees/status` | authenticated | economy-ledger | [src/server.js:3368](../../src/server.js#L3368) | `Fees.feeStatus` |
| GET | `/v1/feud/:characterId` | authenticated | platform-core | [src/server.js:2636](../../src/server.js#L2636) | `G.GameError` |
| POST | `/v1/feud/:targetId/peace` | authenticated | social-combat | [src/server.js:2657](../../src/server.js#L2657) | `S.proposePeace` |
| POST | `/v1/feud/:targetId/peace/accept` | authenticated | social-combat | [src/server.js:2659](../../src/server.js#L2659) | `S.acceptPeace` |
| GET | `/v1/firsts` | authenticated | world-progression | [src/server.js:3283](../../src/server.js#L3283) | `Firsts.firstsBoard` |
| GET | `/v1/forge` | authenticated | chain-economy | [src/server.js:3372](../../src/server.js#L3372) | `Forge.forgeBoard` |
| GET | `/v1/gangs` | public | platform-core | [src/server.js:2280](../../src/server.js#L2280) | — |
| POST | `/v1/gangs` | authenticated | social-combat | [src/server.js:1659](../../src/server.js#L1659) | `S.createGang` |
| GET | `/v1/gangs/:id` | public | social-combat | [src/server.js:2297](../../src/server.js#L2297) | `S.resolveWarIfDue` |
| POST | `/v1/gangs/:id/join` | authenticated | social-combat | [src/server.js:1661](../../src/server.js#L1661) | `S.joinGang` |
| POST | `/v1/gangs/charter/:id` | authenticated | social-combat | [src/server.js:2697](../../src/server.js#L2697) | `S.chooseCharter` |
| GET | `/v1/gangs/chat` | authenticated | platform-core | [src/server.js:2968](../../src/server.js#L2968) | `readChat` |
| POST | `/v1/gangs/chat` | authenticated | platform-core | [src/server.js:2967](../../src/server.js#L2967) | `postChat` |
| POST | `/v1/gangs/contract/:targetId` | authenticated | social-combat | [src/server.js:2672](../../src/server.js#L2672) | `S.postFamilyContract` |
| POST | `/v1/gangs/contract/:targetId/:kind/cancel` | authenticated | social-combat | [src/server.js:2675](../../src/server.js#L2675) | `S.cancelFamilyContract` |
| POST | `/v1/gangs/foundation` | authenticated | engagement-growth | [src/server.js:2695](../../src/server.js#L2695) | `V.buyFoundation` |
| POST | `/v1/gangs/kick` | authenticated | social-combat | [src/server.js:1672](../../src/server.js#L1672) | `S.kickMember` |
| POST | `/v1/gangs/leave` | authenticated | social-combat | [src/server.js:1663](../../src/server.js#L1663) | `S.leaveGang` |
| POST | `/v1/gangs/portfolio/dividend` | authenticated | economy-ledger | [src/server.js:2159](../../src/server.js#L2159) | `Portfolio.claimFamilyDividend` |
| POST | `/v1/gangs/portfolio/invest` | authenticated | economy-ledger | [src/server.js:2153](../../src/server.js#L2153) | `Portfolio.familyInvest` |
| POST | `/v1/gangs/portfolio/name` | authenticated | economy-ledger | [src/server.js:2185](../../src/server.js#L2185) | `Portfolio.nameFamilyDynasty` |
| POST | `/v1/gangs/promote` | authenticated | social-combat | [src/server.js:1690](../../src/server.js#L1690) | `S.promoteMember` |
| POST | `/v1/gangs/tribute` | authenticated | social-combat | [src/server.js:1692](../../src/server.js#L1692) | `S.tribute` |
| POST | `/v1/gangs/tribute/omr` | authenticated | social-combat | [src/server.js:1695](../../src/server.js#L1695) | `S.tributeOmr` |
| POST | `/v1/gangs/vanity/color` | authenticated | engagement-growth | [src/server.js:2689](../../src/server.js#L2689) | `V.recolorGang` |
| POST | `/v1/gangs/vanity/name` | authenticated | engagement-growth | [src/server.js:2691](../../src/server.js#L2691) | `V.renameGang` |
| POST | `/v1/gangs/vanity/seal` | authenticated | engagement-growth | [src/server.js:2693](../../src/server.js#L2693) | `V.buySeal` |
| POST | `/v1/gangs/war/:targetGangId` | authenticated | social-combat | [src/server.js:1697](../../src/server.js#L1697) | `S.declareWar` |
| POST | `/v1/garage/:carId/fence` | authenticated | economy-ledger | [src/server.js:1580](../../src/server.js#L1580) | `E.fenceCar` |
| POST | `/v1/garage/:carId/melt` | authenticated | economy-ledger | [src/server.js:1576](../../src/server.js#L1576) | `E.meltCar` |
| POST | `/v1/garage/:carId/repair` | authenticated | economy-ledger | [src/server.js:1578](../../src/server.js#L1578) | `E.repairCar` |
| POST | `/v1/garage/boost` | authenticated | economy-ledger | [src/server.js:1574](../../src/server.js#L1574) | `E.boostCar` |
| POST | `/v1/gear/:id/mint` | authenticated | chain-economy | [src/server.js:1643](../../src/server.js#L1643) | `E.mintGear` |
| POST | `/v1/gear/:id/withdraw` | authenticated | chain-economy | [src/server.js:3334](../../src/server.js#L3334) | `Chain.requestGearWithdraw` |
| POST | `/v1/goods/buy` | authenticated | economy-ledger | [src/server.js:1592](../../src/server.js#L1592) | `E.buyGood` |
| POST | `/v1/goods/sell` | authenticated | economy-ledger | [src/server.js:1594](../../src/server.js#L1594) | `E.sellGood` |
| POST | `/v1/heal` | authenticated | platform-core | [src/server.js:1531](../../src/server.js#L1531) | `G.withCharacter` |
| POST | `/v1/heist` | authenticated | engagement-growth | [src/server.js:3179](../../src/server.js#L3179) | `W.heist` |
...
| GET | `/v1/home` | authenticated | engagement-growth | [src/server.js:2395](../../src/server.js#L2395) | `Home.homeBoard` |
| GET | `/v1/hustle` | authenticated | platform-core | [src/server.js:1519](../../src/server.js#L1519) | `Hustle.hustleBoard` |
| POST | `/v1/hustle/advance` | authenticated | platform-core | [src/server.js:1521](../../src/server.js#L1521) | `Hustle.advanceHustle` |
| GET | `/v1/identity/:characterId` | public | platform-core | [src/server.js:654](../../src/server.js#L654) | — |
| GET | `/v1/identity/:characterId/portrait.svg` | public | platform-core | [src/server.js:645](../../src/server.js#L645) | — |
| POST | `/v1/identity/bio` | authenticated | engagement-growth | [src/server.js:3205](../../src/server.js#L3205) | `W.setBio` |
| POST | `/v1/identity/mint` | authenticated | chain-economy | [src/server.js:3350](../../src/server.js#L3350) | `Chain.requestDynastyMint` |
| GET | `/v1/invites` | authenticated | platform-core | [src/server.js:3014](../../src/server.js#L3014) | `Invites.inviteBoard` |
| POST | `/v1/invites` | authenticated | platform-core | [src/server.js:3018](../../src/server.js#L3018) | `Invites.issueCrewInvite` |
| POST | `/v1/items/:id/use` | authenticated | economy-ledger | [src/server.js:1588](../../src/server.js#L1588) | `E.useItem` |
...
| GET | `/v1/landmarks` | public | world-progression | [src/server.js:2210](../../src/server.js#L2210) | `Landmarks.landmarkBoard` |
| POST | `/v1/landmarks/:districtId` | authenticated | world-progression | [src/server.js:2211](../../src/server.js#L2211) | `Landmarks.dedicateLandmark` |
...
| GET | `/v1/leaderboard/contacts` | authenticated | engagement-growth | [src/server.js:2987](../../src/server.js#L2987) | `Contacts.contactsLeaderboard` |
...
| GET | `/v1/leaderboard/crews` | authenticated | social-combat | [src/server.js:3057](../../src/server.js#L3057) | `Crew.crewLeaderboard` |
...
| GET | `/v1/leaderboard/mentors` | authenticated | social-combat | [src/server.js:3096](../../src/server.js#L3096) | `Mentor.mentorLeaderboard` |
...
| GET | `/v1/leaderboard/streak` | authenticated | world-progression | [src/server.js:3103](../../src/server.js#L3103) | `Streak.streakLeaderboard` |
...
| GET | `/v1/leaderboard/vouches` | authenticated | social-combat | [src/server.js:3136](../../src/server.js#L3136) | `Vouch.vouchLeaderboard` |
...
| GET | `/v1/live` | authenticated | engagement-growth | [src/server.js:3110](../../src/server.js#L3110) | `Collision.collisionBoard` |
| GET | `/v1/loans` | authenticated | enterprise-logistics | [src/server.js:2097](../../src/server.js#L2097) | `Loans.loanBoard` |
| POST | `/v1/loans` | authenticated | enterprise-logistics | [src/server.js:2101](../../src/server.js#L2101) | `Loans.offerLoan` |
| POST | `/v1/loans/:id/buy` | authenticated | enterprise-logistics | [src/server.js:2138](../../src/server.js#L2138) | `Loans.buyPaper` |
| POST | `/v1/loans/:id/cancel` | authenticated | enterprise-logistics | [src/server.js:2105](../../src/server.js#L2105) | `Loans.cancelLoan` |
| POST | `/v1/loans/:id/collect` | authenticated | enterprise-logistics | [src/server.js:2114](../../src/server.js#L2114) | `Loans.collectLoan` |
| POST | `/v1/loans/:id/repay` | authenticated | enterprise-logistics | [src/server.js:2108](../../src/server.js#L2108) | `Loans.repayLoan` |
| POST | `/v1/loans/:id/sell` | authenticated | enterprise-logistics | [src/server.js:2120](../../src/server.js#L2120) | `Loans.sellPaper` |
| POST | `/v1/loans/:id/take` | authenticated | enterprise-logistics | [src/server.js:2103](../../src/server.js#L2103) | `Loans.takeLoan` |
| POST | `/v1/loans/:id/unsell` | authenticated | enterprise-logistics | [src/server.js:2122](../../src/server.js#L2122) | `Loans.unsellPaper` |
| POST | `/v1/loans/house` | authenticated | enterprise-logistics | [src/server.js:2126](../../src/server.js#L2126) | `Loans.takeHouseLoan` |
| POST | `/v1/loans/house/repay` | authenticated | enterprise-logistics | [src/server.js:2128](../../src/server.js#L2128) | `Loans.repayHouseLoan` |
| POST | `/v1/loans/square` | authenticated | enterprise-logistics | [src/server.js:2135](../../src/server.js#L2135) | `Loans.squareWanted` |
...
| GET | `/v1/map` | authenticated | world-progression | [src/server.js:2377](../../src/server.js#L2377) | `CityMap.cityMap` |
| GET | `/v1/market` | public | economy-ledger | [src/server.js:2250](../../src/server.js#L2250) | `Market.marketBoard` |
| POST | `/v1/market` | authenticated | economy-ledger | [src/server.js:2251](../../src/server.js#L2251) | `Market.listItem` |
| POST | `/v1/market/:id/bid` | authenticated | economy-ledger | [src/server.js:2253](../../src/server.js#L2253) | `Market.bidListing` |
| POST | `/v1/market/:id/buy` | authenticated | economy-ledger | [src/server.js:2255](../../src/server.js#L2255) | `Market.buyListing` |
| POST | `/v1/market/:id/cancel` | authenticated | economy-ledger | [src/server.js:2257](../../src/server.js#L2257) | `Market.cancelListing` |
| POST | `/v1/market/:id/claim` | authenticated | economy-ledger | [src/server.js:2265](../../src/server.js#L2265) | `Market.claimOrder` |
| POST | `/v1/market/:id/fill` | authenticated | economy-ledger | [src/server.js:2263](../../src/server.js#L2263) | `Market.fillOrder` |
| POST | `/v1/market/order` | authenticated | economy-ledger | [src/server.js:2261](../../src/server.js#L2261) | `Market.postOrder` |
| GET | `/v1/market/prices` | public | social-combat | [src/server.js:3419](../../src/server.js#L3419) | `Block.marketPrices` |
| GET | `/v1/mastery` | authenticated | world-progression | [src/server.js:2078](../../src/server.js#L2078) | `Mastery.masteryBoard` |
| POST | `/v1/mastery/trait/:trackId` | authenticated | world-progression | [src/server.js:2080](../../src/server.js#L2080) | `Mastery.chooseTrait` |
| GET | `/v1/me` | authenticated | platform-core | [src/server.js:1489](../../src/server.js#L1489) | `G.readCharacter` |
| GET | `/v1/megaproject` | authenticated | enterprise-logistics | [src/server.js:3485](../../src/server.js#L3485) | `Mega.megaBoard` |
| POST | `/v1/megaproject/cash` | authenticated | enterprise-logistics | [src/server.js:3486](../../src/server.js#L3486) | `Mega.giveCash` |
| POST | `/v1/megaproject/goods` | authenticated | enterprise-logistics | [src/server.js:3488](../../src/server.js#L3488) | `Mega.giveGoods` |
| POST | `/v1/megaproject/omr` | authenticated | enterprise-logistics | [src/server.js:3490](../../src/server.js#L3490) | `Mega.giveOmr` |
| GET | `/v1/mentor` | authenticated | social-combat | [src/server.js:3084](../../src/server.js#L3084) | `Mentor.mentorBoard` |
| POST | `/v1/mentor/accept/:mentorCharId` | authenticated | social-combat | [src/server.js:3090](../../src/server.js#L3090) | `Mentor.acceptMentor` |
| POST | `/v1/mentor/claim` | authenticated | social-combat | [src/server.js:3092](../../src/server.js#L3092) | `Mentor.claimMentor` |
| POST | `/v1/mentor/gift/:protegeCharId` | authenticated | social-combat | [src/server.js:3094](../../src/server.js#L3094) | `Mentor.mentorGift` |
| POST | `/v1/mentor/offer/:characterId` | authenticated | social-combat | [src/server.js:3088](../../src/server.js#L3088) | `Mentor.offerMentor` |
| POST | `/v1/mentor/seeking` | authenticated | social-combat | [src/server.js:3086](../../src/server.js#L3086) | `Mentor.seekMentor` |
| POST | `/v1/missions/:id` | authenticated | engagement-growth | [src/server.js:3181](../../src/server.js#L3181) | `W.doMission` |
| GET | `/v1/mod/actions` | moderator | platform-core | [src/server.js:991](../../src/server.js#L991) | — |
...
| GET | `/v1/mod/brokers` | moderator | platform-core | [src/server.js:2222](../../src/server.js#L2222) | `Brokers.epochBoard` |
| POST | `/v1/mod/brokers/allocate` | moderator | platform-core | [src/server.js:2223](../../src/server.js#L2223) | `Brokers.allocateEpoch` |
...
| GET | `/v1/mod/exchange` | moderator | economy-ledger | [src/server.js:1625](../../src/server.js#L1625) | `Exchange.exchangePool` |
...
| GET | `/v1/nft` | authenticated | platform-core | [src/server.js:3337](../../src/server.js#L3337) | `G.readCharacter` |
| POST | `/v1/nft/:kind/:id/upgrade` | authenticated | platform-core | [src/server.js:3338](../../src/server.js#L3338) | `G.withCharacter` |
| POST | `/v1/nft/:kind/:id/withdraw` | authenticated | chain-economy | [src/server.js:3340](../../src/server.js#L3340) | `Chain.requestItemWithdraw` |
| GET | `/v1/notifications` | authenticated | platform-core | [src/server.js:2729](../../src/server.js#L2729) | — |
| GET | `/v1/npcfamily` | authenticated | world-progression | [src/server.js:3515](../../src/server.js#L3515) | `NpcWar.warBoard` |
| POST | `/v1/npcfamily/:gangId/raid` | authenticated | world-progression | [src/server.js:3517](../../src/server.js#L3517) | `NpcWar.raidFamily` |
| POST | `/v1/npcfamily/:gangId/war` | authenticated | world-progression | [src/server.js:3522](../../src/server.js#L3522) | `NpcWar.declareNpcWar` |
| POST | `/v1/npcfamily/collect` | authenticated | world-progression | [src/server.js:3519](../../src/server.js#L3519) | `NpcWar.collectFamilyTribute` |
| GET | `/v1/onboard` | authenticated | engagement-growth | [src/server.js:3190](../../src/server.js#L3190) | `W.onboardBoard` |
| POST | `/v1/onboard/:taskId/claim` | authenticated | engagement-growth | [src/server.js:3292](../../src/server.js#L3292) | `W.claimOnboard` |
| GET | `/v1/online` | public | platform-core | [src/server.js:2844](../../src/server.js#L2844) | — |
| GET | `/v1/opportunities` | authenticated | engagement-growth | [src/server.js:2505](../../src/server.js#L2505) | `opportunityBoard` |
| GET | `/v1/paper` | authenticated | engagement-growth | [src/server.js:2490](../../src/server.js#L2490) | `People.paperBoard` |
| POST | `/v1/paper/read` | authenticated | engagement-growth | [src/server.js:2492](../../src/server.js#L2492) | `People.foldPaper` |
| GET | `/v1/pass` | authenticated | platform-core | [src/server.js:3402](../../src/server.js#L3402) | `Pass.passBoard` |
| POST | `/v1/pass/claim` | authenticated | platform-core | [src/server.js:3403](../../src/server.js#L3403) | `Pass.claimPass` |
| POST | `/v1/path` | authenticated | engagement-growth | [src/server.js:3174](../../src/server.js#L3174) | `W.choosePath` |
| POST | `/v1/path-quiz` | public | platform-core | [src/server.js:1214](../../src/server.js#L1214) | `G.track` |
| GET | `/v1/payroll` | authenticated | enterprise-logistics | [src/server.js:2387](../../src/server.js#L2387) | `Payroll.payrollBoard` |
...
| GET | `/v1/people` | authenticated | engagement-growth | [src/server.js:2484](../../src/server.js#L2484) | `People.peopleBoard` |
| GET | `/v1/people/history/:characterId` | authenticated | engagement-growth | [src/server.js:2486](../../src/server.js#L2486) | `People.pairHistory` |
| GET | `/v1/phone` | authenticated | platform-core | [src/server.js:2974](../../src/server.js#L2974) | `Phone.phoneBoard` |
| DELETE | `/v1/phone/block/:characterId` | authenticated | platform-core | [src/server.js:2981](../../src/server.js#L2981) | `Phone.unblockLine` |
| POST | `/v1/phone/block/:characterId` | authenticated | platform-core | [src/server.js:2979](../../src/server.js#L2979) | `Phone.blockLine` |
| POST | `/v1/phone/dm/:characterId` | authenticated | platform-core | [src/server.js:2977](../../src/server.js#L2977) | `Phone.sendDm` |
| GET | `/v1/phone/thread/:characterId` | authenticated | platform-core | [src/server.js:2975](../../src/server.js#L2975) | `Phone.readThread` |
| POST | `/v1/plex/mint` | authenticated | economy-ledger | [src/server.js:3380](../../src/server.js#L3380) | `Vig.payPlex` |
| GET | `/v1/plex/price` | public | economy-ledger | [src/server.js:3387](../../src/server.js#L3387) | `Vig.plexQuote` |
| POST | `/v1/plex/respawn` | authenticated | economy-ledger | [src/server.js:3382](../../src/server.js#L3382) | `Vig.payPlex` |
...
| GET | `/v1/portfolio` | authenticated | economy-ledger | [src/server.js:2149](../../src/server.js#L2149) | `Portfolio.portfolioBoard` |
| POST | `/v1/portfolio/dividend` | authenticated | economy-ledger | [src/server.js:2156](../../src/server.js#L2156) | `Portfolio.claimDividend` |
| POST | `/v1/portfolio/invest` | authenticated | economy-ledger | [src/server.js:2151](../../src/server.js#L2151) | `Portfolio.invest` |
| GET | `/v1/primetime` | authenticated | engagement-growth | [src/server.js:3120](../../src/server.js#L3120) | `Prime.primeTimeBoard` |
| POST | `/v1/primetime/answer` | authenticated | engagement-growth | [src/server.js:3122](../../src/server.js#L3122) | `Prime.answerCall` |
| POST | `/v1/primetime/round` | authenticated | engagement-growth | [src/server.js:3124](../../src/server.js#L3124) | `Prime.buyRound` |
| POST | `/v1/primetime/siege` | authenticated | engagement-growth | [src/server.js:3126](../../src/server.js#L3126) | `Prime.joinSiege` |
| GET | `/v1/profile` | authenticated | engagement-growth | [src/server.js:3201](../../src/server.js#L3201) | `W.myProfile` |
| GET | `/v1/provenance` | authenticated | engagement-growth | [src/server.js:2428](../../src/server.js#L2428) | `Drop.colorsBoard` |
| POST | `/v1/provenance` | authenticated | engagement-growth | [src/server.js:2430](../../src/server.js#L2430) | `Drop.claimColors` |
| POST | `/v1/push/subscribe` | authenticated | engagement-growth | [src/server.js:3139](../../src/server.js#L3139) | `Push.saveSubscription` |
| POST | `/v1/push/unsubscribe` | authenticated | engagement-growth | [src/server.js:3141](../../src/server.js#L3141) | `Push.removeSubscription` |
...
| DELETE | `/v1/rackets/:id` | authenticated | economy-ledger | [src/server.js:1608](../../src/server.js#L1608) | `E.retireRacket` |
| POST | `/v1/rackets/:id/buy` | authenticated | economy-ledger | [src/server.js:1598](../../src/server.js#L1598) | `E.buyRacket` |
| POST | `/v1/rackets/:id/upgrade` | authenticated | economy-ledger | [src/server.js:1605](../../src/server.js#L1605) | `E.upgradeRacket` |
| POST | `/v1/referral/claim` | authenticated | engagement-growth | [src/server.js:3198](../../src/server.js#L3198) | `W.claimReferral` |
| GET | `/v1/regimen` | authenticated | platform-core | [src/server.js:1512](../../src/server.js#L1512) | `RG.regimenBoard` |
| POST | `/v1/regimen/:id` | authenticated | platform-core | [src/server.js:1514](../../src/server.js#L1514) | `RG.trainDiscipline` |
| POST | `/v1/regimen/drill/:npc` | authenticated | platform-core | [src/server.js:1516](../../src/server.js#L1516) | `RG.claimDrill` |
| POST | `/v1/respec` | authenticated | engagement-growth | [src/server.js:3177](../../src/server.js#L3177) | `W.respec` |
| GET | `/v1/results` | public | platform-core | [src/server.js:3077](../../src/server.js#L3077) | — |
| GET | `/v1/rivals` | authenticated | social-combat | [src/server.js:2480](../../src/server.js#L2480) | `Rivals.rivalsBoard` |
| GET | `/v1/roster` | authenticated | social-combat | [src/server.js:1705](../../src/server.js#L1705) | `S.rosterOf` |
| DELETE | `/v1/roster/:post` | authenticated | social-combat | [src/server.js:1709](../../src/server.js#L1709) | `S.vacatePost` |
| POST | `/v1/roster/:post` | authenticated | social-combat | [src/server.js:1707](../../src/server.js#L1707) | `S.assignPost` |
| GET | `/v1/rules` | public | platform-core | [src/server.js:1727](../../src/server.js#L1727) | `jsonEtag` |
...
| POST | `/v1/safehouse` | authenticated | social-combat | [src/server.js:2669](../../src/server.js#L2669) | `S.enterSafehouse` |
| POST | `/v1/screens` | authenticated | platform-core | [src/server.js:1555](../../src/server.js#L1555) | `G.track` |
| GET | `/v1/season/recap` | authenticated | world-progression | [src/server.js:3425](../../src/server.js#L3425) | `Season.seasonRecaps` |
| GET | `/v1/seasons` | public | world-progression | [src/server.js:3423](../../src/server.js#L3423) | `Season.seasonBoard` |
| GET | `/v1/secrets` | authenticated | law-intelligence | [src/server.js:3249](../../src/server.js#L3249) | `Secrets.secretsBoard` |
| POST | `/v1/secrets/:id/expose` | authenticated | law-intelligence | [src/server.js:3269](../../src/server.js#L3269) | `Secrets.exposeSecret` |
| POST | `/v1/secrets/:id/extort` | authenticated | law-intelligence | [src/server.js:3253](../../src/server.js#L3253) | `Secrets.extortSecret` |
| POST | `/v1/secrets/:id/pay` | authenticated | law-intelligence | [src/server.js:3257](../../src/server.js#L3257) | `Secrets.payHush` |
| GET | `/v1/session` | authenticated | platform-core | [src/server.js:1494](../../src/server.js#L1494) | — |
| GET | `/v1/shipment` | authenticated | enterprise-logistics | [src/server.js:3286](../../src/server.js#L3286) | `Shipment.shipmentBoard` |
| POST | `/v1/shipment/commission/:id` | authenticated | enterprise-logistics | [src/server.js:3290](../../src/server.js#L3290) | `Shipment.commissionPiece` |
| POST | `/v1/shipment/take` | authenticated | enterprise-logistics | [src/server.js:3288](../../src/server.js#L3288) | `Shipment.takeShipment` |
| GET | `/v1/skills` | authenticated | world-progression | [src/server.js:2075](../../src/server.js#L2075) | `Skills.skillsBoard` |
| POST | `/v1/skills/:id` | authenticated | world-progression | [src/server.js:2089](../../src/server.js#L2089) | `Skills.learnSkill` |
| POST | `/v1/skills/active/:ability` | authenticated | world-progression | [src/server.js:2085](../../src/server.js#L2085) | `Skills.useActive` |
| POST | `/v1/skills/respec` | authenticated | world-progression | [src/server.js:2082](../../src/server.js#L2082) | `Skills.respecSkills` |
| POST | `/v1/skills/respec/:id` | authenticated | world-progression | [src/server.js:2087](../../src/server.js#L2087) | `Skills.respecOne` |
| GET | `/v1/social` | authenticated | engagement-growth | [src/server.js:3295](../../src/server.js#L3295) | `W.socialBoard` |
| POST | `/v1/social/:taskId/claim` | authenticated | engagement-growth | [src/server.js:3299](../../src/server.js#L3299) | `W.claimSocial` |
| GET | `/v1/soldiers` | authenticated | social-combat | [src/server.js:3238](../../src/server.js#L3238) | `Soldiers.soldierBoard` |
| DELETE | `/v1/soldiers/:id` | authenticated | social-combat | [src/server.js:3246](../../src/server.js#L3246) | `Soldiers.dismissSoldier` |
| POST | `/v1/soldiers/:id/assign` | authenticated | social-combat | [src/server.js:3242](../../src/server.js#L3242) | `Soldiers.assignSoldier` |
| POST | `/v1/soldiers/hire` | authenticated | social-combat | [src/server.js:3240](../../src/server.js#L3240) | `Soldiers.hireSoldier` |
| POST | `/v1/soldiers/unassign` | authenticated | social-combat | [src/server.js:3244](../../src/server.js#L3244) | `Soldiers.unassignSoldier` |
...
| POST | `/v1/stake` | authenticated | economy-ledger | [src/server.js:1633](../../src/server.js#L1633) | `E.stake` |
| POST | `/v1/stake/lock` | authenticated | economy-ledger | [src/server.js:1639](../../src/server.js#L1639) | `E.lockStake` |
| GET | `/v1/store` | authenticated | platform-core | [src/server.js:3394](../../src/server.js#L3394) | `Store.storeBoard` |
| POST | `/v1/store/plex/:sku` | authenticated | platform-core | [src/server.js:3396](../../src/server.js#L3396) | `Store.payPackagePlex` |
| GET | `/v1/streak` | authenticated | world-progression | [src/server.js:3099](../../src/server.js#L3099) | `Streak.streakBoard` |
| POST | `/v1/streak/claim` | authenticated | world-progression | [src/server.js:3101](../../src/server.js#L3101) | `Streak.claimStreak` |
| GET | `/v1/streets` | authenticated | platform-core | [src/server.js:2435](../../src/server.js#L2435) | — |
| POST | `/v1/streets/:targetId/boat` | authenticated | social-combat | [src/server.js:2476](../../src/server.js#L2476) | `S.stealBoat` |
| POST | `/v1/streets/:targetId/bounty` | authenticated | social-combat | [src/server.js:2494](../../src/server.js#L2494) | `S.postBounty` |
| POST | `/v1/streets/:targetId/bust` | authenticated | social-combat | [src/server.js:2708](../../src/server.js#L2708) | `S.bust` |
| POST | `/v1/streets/:targetId/fire` | authenticated | social-combat | [src/server.js:2703](../../src/server.js#L2703) | `S.fire` |
| POST | `/v1/streets/:targetId/jump` | authenticated | social-combat | [src/server.js:2467](../../src/server.js#L2467) | `S.jump` |
| POST | `/v1/streets/:targetId/npchit` | authenticated | social-combat | [src/server.js:2661](../../src/server.js#L2661) | `S.npcHit` |
| POST | `/v1/streets/:targetId/sabotage` | authenticated | social-combat | [src/server.js:2478](../../src/server.js#L2478) | `S.sabotage` |
| POST | `/v1/streets/:targetId/search` | authenticated | social-combat | [src/server.js:2699](../../src/server.js#L2699) | `S.startSearch` |
| POST | `/v1/streets/:targetId/steal` | authenticated | social-combat | [src/server.js:2471](../../src/server.js#L2471) | `S.stealCar` |
| POST | `/v1/streets/:targetId/trunk` | authenticated | social-combat | [src/server.js:2474](../../src/server.js#L2474) | `S.robTrunk` |
| DELETE | `/v1/streets/search` | authenticated | social-combat | [src/server.js:2701](../../src/server.js#L2701) | `S.callOffSearch` |
| POST | `/v1/swap` | authenticated | economy-ledger | [src/server.js:1631](../../src/server.js#L1631) | `E.swap` |
...
| POST | `/v1/train/:stat` | authenticated | platform-core | [src/server.js:1509](../../src/server.js#L1509) | `G.withCharacter` |
| POST | `/v1/travel/:district` | authenticated | platform-core | [src/server.js:1570](../../src/server.js#L1570) | `G.withCharacter` |
| GET | `/v1/u/:name` | public | platform-core | [src/server.js:697](../../src/server.js#L697) | `Cards.publicDossier` |
...
| POST | `/v1/unstake` | authenticated | economy-ledger | [src/server.js:1635](../../src/server.js#L1635) | `E.unstake` |
| POST | `/v1/vanity/name` | authenticated | engagement-growth | [src/server.js:2683](../../src/server.js#L2683) | `V.changeName` |
| POST | `/v1/vanity/plate/:carId` | authenticated | engagement-growth | [src/server.js:2687](../../src/server.js#L2687) | `V.setPlate` |
| POST | `/v1/vanity/title` | authenticated | engagement-growth | [src/server.js:2685](../../src/server.js#L2685) | `V.setTitle` |
| GET | `/v1/vault` | authenticated | economy-ledger | [src/server.js:2168](../../src/server.js#L2168) | `Treasury.vaultBoard` |
| POST | `/v1/vault/claim` | authenticated | economy-ledger | [src/server.js:2182](../../src/server.js#L2182) | `Treasury.claimVaulted` |
| DELETE | `/v1/vouch/:characterId` | authenticated | social-combat | [src/server.js:3134](../../src/server.js#L3134) | `Vouch.revokeVouch` |
| POST | `/v1/vouch/:characterId` | authenticated | social-combat | [src/server.js:3132](../../src/server.js#L3132) | `Vouch.giveVouch` |
| GET | `/v1/vouches` | authenticated | social-combat | [src/server.js:3130](../../src/server.js#L3130) | `Vouch.vouchBoard` |
| GET | `/v1/wage` | authenticated | economy-ledger | [src/server.js:3208](../../src/server.js#L3208) | `Emission.wageBoard` |
| POST | `/v1/wallet` | authenticated | chain-economy | [src/server.js:3304](../../src/server.js#L3304) | `G.GameError` |
| POST | `/v1/wallet/challenge` | authenticated | chain-economy | [src/server.js:3325](../../src/server.js#L3325) | `Chain.walletChallenge` |
| POST | `/v1/wallet/verify` | authenticated | chain-economy | [src/server.js:3326](../../src/server.js#L3326) | `Chain.walletVerify` |
| GET | `/v1/window` | authenticated | economy-ledger | [src/server.js:1619](../../src/server.js#L1619) | `Exchange.exchangeBoard` |
| POST | `/v1/window/redeem` | authenticated | economy-ledger | [src/server.js:1621](../../src/server.js#L1621) | `Exchange.redeem` |
| GET | `/v1/wire` | authenticated | law-intelligence | [src/server.js:2226](../../src/server.js#L2226) | `Wire.wireBoard` |
| POST | `/v1/wire/dig/:targetId` | authenticated | law-intelligence | [src/server.js:3251](../../src/server.js#L3251) | `Secrets.digSecret` |
| POST | `/v1/wire/disinfo` | authenticated | law-intelligence | [src/server.js:2244](../../src/server.js#L2244) | `Wire.plantDisinfo` |
| POST | `/v1/wire/dossier/:targetId` | authenticated | law-intelligence | [src/server.js:2242](../../src/server.js#L2242) | `Wire.pullDossier` |
| POST | `/v1/wire/informant/:targetId` | authenticated | law-intelligence | [src/server.js:2246](../../src/server.js#L2246) | `Wire.recruitInformant` |
| POST | `/v1/wire/subscribe` | authenticated | law-intelligence | [src/server.js:2232](../../src/server.js#L2232) | `Wire.subscribeWire` |
| POST | `/v1/wire/sweep` | authenticated | law-intelligence | [src/server.js:2230](../../src/server.js#L2230) | `Wire.sweepBugs` |
| POST | `/v1/wire/tap/:targetId` | authenticated | law-intelligence | [src/server.js:2228](../../src/server.js#L2228) | `Wire.placeTap` |
| POST | `/v1/wire/trace` | authenticated | law-intelligence | [src/server.js:2240](../../src/server.js#L2240) | `Wire.traceBugs` |
| DELETE | `/v1/wire/watch/:targetId` | authenticated | law-intelligence | [src/server.js:2237](../../src/server.js#L2237) | `Wire.cancelWatch` |
| POST | `/v1/wire/watch/:targetId` | authenticated | law-intelligence | [src/server.js:2235](../../src/server.js#L2235) | `Wire.enrollWatch` |
| POST | `/v1/withdraw` | authenticated | chain-economy | [src/server.js:3328](../../src/server.js#L3328) | `Chain.requestWithdraw` |
| POST | `/v1/withdraw/:id/cancel` | authenticated | chain-economy | [src/server.js:3332](../../src/server.js#L3332) | `Chain.cancelQueuedWithdraw` |
| GET | `/v1/withdraw/status` | authenticated | chain-economy | [src/server.js:3352](../../src/server.js#L3352) | `Chain.reserveStatus` |
| POST | `/v1/workshop/ammo` | authenticated | economy-ledger | [src/server.js:1586](../../src/server.js#L1586) | `E.craftAmmo` |
| POST | `/v1/workshop/craft/:id` | authenticated | economy-ledger | [src/server.js:1584](../../src/server.js#L1584) | `E.craft` |
| GET | `/v1/world` | authenticated | world-progression | [src/server.js:3510](../../src/server.js#L3510) | `World.worldBoard` |
| POST | `/v1/world/:npcId/invade` | authenticated | world-progression | [src/server.js:3540](../../src/server.js#L3540) | `World.invadeOutpost` |
| POST | `/v1/world/:npcId/plan` | authenticated | world-progression | [src/server.js:3526](../../src/server.js#L3526) | `World.planRaid` |
| POST | `/v1/world/:npcId/raid` | authenticated | world-progression | [src/server.js:3512](../../src/server.js#L3512) | `World.raidNpc` |
| POST | `/v1/world/:npcId/reinforce` | authenticated | world-progression | [src/server.js:3543](../../src/server.js#L3543) | `World.reinforceOutpost` |
| POST | `/v1/world/collect` | authenticated | world-progression | [src/server.js:3538](../../src/server.js#L3538) | `World.collectFrontier` |
| GET | `/v1/world/raids` | authenticated | world-progression | [src/server.js:3524](../../src/server.js#L3524) | `World.raidBoard` |
| POST | `/v1/world/raids/:id/dismiss` | authenticated | world-progression | [src/server.js:3532](../../src/server.js#L3532) | `World.dismissGun` |
| POST | `/v1/world/raids/:id/go` | authenticated | world-progression | [src/server.js:3536](../../src/server.js#L3536) | `World.executeRaid` |
| POST | `/v1/world/raids/:id/hire` | authenticated | world-progression | [src/server.js:3530](../../src/server.js#L3530) | `World.hireRaid` |
| POST | `/v1/world/raids/:id/join` | authenticated | world-progression | [src/server.js:3528](../../src/server.js#L3528) | `World.joinRaid` |
| POST | `/v1/world/raids/:id/leave` | authenticated | world-progression | [src/server.js:3534](../../src/server.js#L3534) | `World.leaveRaid` |
...
| GET | `/v1/worldgraph/kernel/recipes` | public | platform-core | [src/routes/world-kernel.js:77](../../src/routes/world-kernel.js#L77) | — |
| POST | `/v1/worldgraph/kernel/recipes/:recipeId/craft` | public | world-graph | [src/routes/world-kernel.js:79](../../src/routes/world-kernel.js#L79) | `withItemTransaction` |
...
| GET | `/v1/worldgraph/objects` | public | platform-core | [src/routes/world-kernel.js:73](../../src/routes/world-kernel.js#L73) | — |
| GET | `/v1/worldgraph/objects/:objectId` | public | platform-core | [src/routes/world-kernel.js:74](../../src/routes/world-kernel.js#L74) | — |
| POST | `/v1/worldgraph/objects/:objectId/actions/:actionId` | public | platform-core | [src/routes/world-kernel.js:75](../../src/routes/world-kernel.js#L75) | — |
...
| GET | `/v1/worldgraph/state` | public | platform-core | [src/routes/world-kernel.js:72](../../src/routes/world-kernel.js#L72) | — |
| GET | `/v1/ws` | token-query | platform-core | [src/server.js:2752](../../src/server.js#L2752) | — |
| GET | `/v1/yield` | public | economy-ledger | [src/server.js:1623](../../src/server.js#L1623) | `Exchange.yieldBoard` |
| GET | `/wiki` | public | client-experience | [src/server.js:485](../../src/server.js#L485) | `servePage` |
