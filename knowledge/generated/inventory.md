...
> Source: worktree at `85bbc055d21c`. Rebuild with `npm run knowledge`. Do not edit by hand.

## Census

| Measure | Count |
|---|---:|
| Current artifacts | 3,692 |
| Text lines | 1,234,461 |
| Repository bytes inventoried | 911,470,830 |
...
| Graph nodes / edges | 9,077 / 38,676 |
