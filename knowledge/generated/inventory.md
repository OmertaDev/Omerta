...
> Source: worktree at `0f56e6b8e232`. Rebuild with `npm run knowledge`. Do not edit by hand.

## Census

| Measure | Count |
|---|---:|
| Current artifacts | 3,278 |
| Text lines | 1,041,746 |
| Repository bytes inventoried | 904,583,079 |
...
| Graph nodes / edges | 7,900 / 34,422 |
