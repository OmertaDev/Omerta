...
> Source: worktree at `982ba81b2db3`. Rebuild with `npm run knowledge`. Do not edit by hand.
...
| Text lines | 400,419 |
| Repository bytes inventoried | 274,546,425 |
...
| Graph nodes / edges | 4,593 / 21,535 |
