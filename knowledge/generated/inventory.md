...
> Source: worktree at `b5b55217fb1f`. Rebuild with `npm run knowledge`. Do not edit by hand.

## Census

| Measure | Count |
|---|---:|
| Current artifacts | 3,736 |
| Text lines | 1,236,208 |
| Repository bytes inventoried | 915,294,573 |
...
| Graph nodes / edges | 9,156 / 38,957 |
