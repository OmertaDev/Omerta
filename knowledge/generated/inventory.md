...
> Source: worktree at `815d02a81194`. Rebuild with `npm run knowledge`. Do not edit by hand.

## Census

| Measure | Count |
|---|---:|
| Current artifacts | 3,309 |
| Text lines | 1,120,951 |
| Repository bytes inventoried | 904,384,811 |
...
| Graph nodes / edges | 8,010 / 34,797 |
