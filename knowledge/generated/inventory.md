...
> Source: worktree at `b068a581ffa3`. Rebuild with `npm run knowledge`. Do not edit by hand.

## Census

| Measure | Count |
|---|---:|
| Current artifacts | 2,926 |
| Text lines | 839,611 |
| Repository bytes inventoried | 825,416,590 |
...
| Graph nodes / edges | 7,483 / 33,107 |
