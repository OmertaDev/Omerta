...
> Source: worktree at `a24eea9de4eb`. Rebuild with `npm run knowledge`. Do not edit by hand.

## Census

| Measure | Count |
|---|---:|
| Current artifacts | 1,900 |
| Text lines | 568,366 |
| Repository bytes inventoried | 316,644,535 |
| Backend/route modules | 212 |
...
| Graph nodes / edges | 5,925 / 26,477 |
...
| [schema.sql](../../schema.sql) | 6,578 | data-schema | 2026-09-07 |
