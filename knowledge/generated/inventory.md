...
> Source: worktree at `dcfb07a82260`. Rebuild with `npm run knowledge`. Do not edit by hand.

## Census

| Measure | Count |
|---|---:|
| Current artifacts | 3,439 |
| Text lines | 1,170,462 |
| Repository bytes inventoried | 906,841,166 |
...
| Graph nodes / edges | 8,372 / 36,085 |
