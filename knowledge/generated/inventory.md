...
> Source: worktree at `9b5e1f54d084`. Rebuild with `npm run knowledge`. Do not edit by hand.

## Census

| Measure | Count |
|---|---:|
| Current artifacts | 1,648 |
| Text lines | 423,456 |
| Repository bytes inventoried | 276,403,281 |
...
| Graph nodes / edges | 4,998 / 22,391 |
