...
> Source: worktree at `ab7550dccd5c`. Rebuild with `npm run knowledge`. Do not edit by hand.

## Census

| Measure | Count |
|---|---:|
| Current artifacts | 3,533 |
| Text lines | 1,196,814 |
| Repository bytes inventoried | 908,196,672 |
...
| Graph nodes / edges | 8,594 / 36,893 |
