...
> Source: worktree at `89d4d6b33e3e`. Rebuild with `npm run knowledge`. Do not edit by hand.

## Census

| Measure | Count |
|---|---:|
| Current artifacts | 3,380 |
| Text lines | 1,146,847 |
| Repository bytes inventoried | 905,719,095 |
...
| Graph nodes / edges | 8,217 / 35,573 |
