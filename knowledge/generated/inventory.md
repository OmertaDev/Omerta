...
> Source: worktree at `503a7a3cd32f`. Rebuild with `npm run knowledge`. Do not edit by hand.
...
| Text lines | 515,174 |
| Repository bytes inventoried | 313,529,979 |
...
| Graph nodes / edges | 5,586 / 24,446 |
