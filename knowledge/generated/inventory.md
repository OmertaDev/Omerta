...
> Source: worktree at `6a189cca381a`. Rebuild with `npm run knowledge`. Do not edit by hand.

## Census

| Measure | Count |
|---|---:|
| Current artifacts | 3,539 |
| Text lines | 1,197,561 |
| Repository bytes inventoried | 908,256,305 |
...
| Graph nodes / edges | 8,608 / 36,955 |
