...
> Source: worktree at `45082605e23e`. Rebuild with `npm run knowledge`. Do not edit by hand.

## Census

| Measure | Count |
|---|---:|
| Current artifacts | 3,291 |
| Text lines | 1,114,902 |
| Repository bytes inventoried | 904,089,005 |
...
| Graph nodes / edges | 7,957 / 34,596 |
