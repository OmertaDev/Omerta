...
> Source: worktree at `94a213b30d3a`. Rebuild with `npm run knowledge`. Do not edit by hand.
...
| Text lines | 390,757 |
| Repository bytes inventoried | 274,520,245 |
...
| Graph nodes / edges | 4,568 / 21,528 |
