...
> Source: worktree at `c72c7f6a0f19`. Rebuild with `npm run knowledge`. Do not edit by hand.

## Census

| Measure | Count |
|---|---:|
| Current artifacts | 3,273 |
| Text lines | 1,107,734 |
| Repository bytes inventoried | 903,181,207 |
...
| Graph nodes / edges | 7,913 / 34,431 |
