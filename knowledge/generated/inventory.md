...
> Source: worktree at `e7b0cd2df5f0`. Rebuild with `npm run knowledge`. Do not edit by hand.
...
| Text lines | 519,759 |
| Repository bytes inventoried | 313,888,305 |
...
| Graph nodes / edges | 5,663 / 24,879 |
