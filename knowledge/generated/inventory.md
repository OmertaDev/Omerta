...
> Source: worktree at `1d02eb2d5816`. Rebuild with `npm run knowledge`. Do not edit by hand.

## Census

| Measure | Count |
|---|---:|
| Current artifacts | 3,342 |
| Text lines | 1,132,414 |
| Repository bytes inventoried | 905,009,930 |
...
| Graph nodes / edges | 8,103 / 35,129 |
