...
> Source: worktree at `4da713ba3673`. Rebuild with `npm run knowledge`. Do not edit by hand.

## Census

| Measure | Count |
|---|---:|
| Current artifacts | 3,368 |
| Text lines | 1,143,319 |
| Repository bytes inventoried | 905,518,100 |
...
| Graph nodes / edges | 8,185 / 35,411 |
