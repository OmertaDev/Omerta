...
> Source: worktree at `9e8dfb73054c`. Rebuild with `npm run knowledge`. Do not edit by hand.
...
| Text lines | 376,445 |
| Repository bytes inventoried | 273,537,069 |
...
| Graph nodes / edges | 4,447 / 20,927 |
