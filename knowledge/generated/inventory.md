...
> Source: worktree at `b19e9decfcbd`. Rebuild with `npm run knowledge`. Do not edit by hand.

## Census

| Measure | Count |
|---|---:|
| Current artifacts | 3,564 |
| Text lines | 1,202,865 |
| Repository bytes inventoried | 908,570,614 |
...
| Graph nodes / edges | 8,679 / 37,191 |
