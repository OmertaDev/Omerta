...
> Source: worktree at `bd02ab4cd35e`. Rebuild with `npm run knowledge`. Do not edit by hand.

## Census

| Measure | Count |
|---|---:|
| Current artifacts | 3,497 |
| Text lines | 1,189,062 |
| Repository bytes inventoried | 907,728,074 |
...
| Graph nodes / edges | 8,510 / 36,607 |
