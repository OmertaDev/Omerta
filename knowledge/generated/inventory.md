...
> Source: worktree at `37de4acdf8ef`. Rebuild with `npm run knowledge`. Do not edit by hand.
...
| Text lines | 527,863 |
| Repository bytes inventoried | 314,556,646 |
...
| Graph nodes / edges | 5,709 / 25,394 |
