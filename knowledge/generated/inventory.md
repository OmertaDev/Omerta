...
> Source: worktree at `daa94f61f93f`. Rebuild with `npm run knowledge`. Do not edit by hand.
...
| Text lines | 525,755 |
| Repository bytes inventoried | 314,382,578 |
...
| Graph nodes / edges | 5,690 / 25,222 |
