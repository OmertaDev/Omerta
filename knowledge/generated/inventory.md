...
> Source: worktree at `6252c27155b4`. Rebuild with `npm run knowledge`. Do not edit by hand.

## Census

| Measure | Count |
|---|---:|
| Current artifacts | 3,457 |
| Text lines | 1,176,572 |
| Repository bytes inventoried | 907,129,631 |
...
| Graph nodes / edges | 8,410 / 36,231 |
