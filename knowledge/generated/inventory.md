...
> Source: worktree at `f107791cb855`. Rebuild with `npm run knowledge`. Do not edit by hand.

## Census

| Measure | Count |
|---|---:|
| Current artifacts | 1,905 |
| Text lines | 572,123 |
| Repository bytes inventoried | 316,944,714 |
...
| Graph nodes / edges | 5,955 / 26,773 |
