...
> Source: worktree at `e4a6994bfee0`. Rebuild with `npm run knowledge`. Do not edit by hand.

## Census

| Measure | Count |
|---|---:|
| Current artifacts | 3,220 |
| Text lines | 1,012,336 |
| Repository bytes inventoried | 766,828,860 |
...
| Graph nodes / edges | 7,901 / 33,210 |
