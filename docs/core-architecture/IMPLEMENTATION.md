...
Phase 1 branch: `codex/core-architecture-20260917`; continuation: `codex/core-coordination-20260917`. No production activation or deployment.
...
2. Coordination Engine Core: component completion gate passed; source checkpoint follows this record. Family operations extend existing operation tables and preserve Crew gameplay.
