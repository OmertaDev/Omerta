    ...
    posts: [
      {
        ...
        asset: '01-city-treasury.png',
        alt: 'OMERTÀ Market V2. The city has a treasury. A miniature noir city inside an open bank vault. Built and tested; not deployed.'
      },
      {
        ...
        alt: 'The seven Market V2 compartments: Core, Lower Cushion, Garrison, Upper Cushion, Desk, War Chest and Turf. Finite capital with distinct roles.'
      },
      {
    ...
    posts: [
      {
        ...
        asset: '02-reserve-desk.png',
        alt: 'OMERTÀ Market V2. Capital with orders. A noir treasury desk with seven ledger compartments. Seven compartments, finite budgets. Built and tested; not deployed.'
      },
      {
    ...
    posts: [
      {
        ...
        asset: '03-turf-city.png',
        alt: 'OMERTÀ Market V2. Control the Turf. A noir city model with district boundaries and family markers. Family fee rights, protocol-owned principal. Built and tested; not deployed.'
      },
      {
...
const standalone = [
  {
    ...
    asset: '01-city-treasury.png',
    alt: 'The city has a treasury. OMERTÀ Market V2 announcement, with a miniature noir city inside an open bank vault. Built and tested; not deployed.'
  },
  {
    id: 's02-tax-map',
  ...
  },
  {
    ...
    asset: '02-reserve-desk.png',
    alt: 'Capital with orders. A noir treasury desk representing seven distinct capital compartments and finite budgets. OMERTÀ Market V2 is built and tested, not deployed.'
  },
  {
  ...
  },
  {
    ...
    asset: '03-turf-city.png',
    alt: 'Control the Turf. A noir city marked with family boundaries. Family fee rights are separate from protocol-owned liquidity principal. Built and tested; not deployed.'
  }
];
