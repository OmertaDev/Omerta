...
const directory = path.resolve(path.dirname(fileURLToPath(import.meta.url)), '../../../output/omerta-connected-city');
const types = {'.html': 'text/html; charset=utf-8', '.mp4': 'video/mp4', '.png': 'image/png', '.jpg': 'image/jpeg', '.vtt': 'text/vtt', '.srt': 'text/plain', '.json': 'application/json'};
...
}).listen(8816, '127.0.0.1', () => console.log('Campaign gallery: http://127.0.0.1:8816'));
