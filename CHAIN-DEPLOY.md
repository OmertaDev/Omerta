...
2. **A scoped agent-led review of the CONTRACTS *and* the off-chain EIP-712 signer** under
   ...
   **In the batch — 38 contracts + 1 interface, every contract carrying tests:**
   ...
   | Genesis participation | `GenesisWalletCap` | 0.5 ETH cumulative commitment per wallet; only the controller-bound CCA may validate; caller equals recipient; rejected bids roll back and refunds never replenish allowance; no NFT or identity gate |
