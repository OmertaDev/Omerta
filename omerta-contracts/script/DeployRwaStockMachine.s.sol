...
contract DeployRwaStockMachine is Script {
    function run() external returns (address registryAddress, address buyerAddress) {
        ...
        address stockVault = vm.envAddress("STOCK_VAULT_ADDRESS");
        ...
        require(safe != address(0), "DeployRwa: zero SAFE");
        require(stockVault != address(0), "DeployRwa: zero STOCK_VAULT_ADDRESS");
