...
import {TestTwapWeth, TestFixedOmrV2Pair} from "./testnet/TestTwapDependencies.sol";
...
contract DeployTestnetTwap is Script {
    ...
    function run() external returns (Deployment memory d) {
        ...
        d.oracle = new OmrTwapOracle(safe, IUniswapV2Pair(address(d.testPair)), omr, uint32(period));
        vm.stopBroadcast();
