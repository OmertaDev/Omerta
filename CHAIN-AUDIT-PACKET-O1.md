...
| 48 | `GenesisWalletCap` | controller-bound CCA validation; cumulative 1 ETH commitment per bidding wallet; no reset on exit or refund and no separate-recipient bypass | `GenesisWalletCap.t.sol` |
